	...
	return (
		...
		>
			<head>
				...
				/>
				<link
					href="https://fonts.googleapis.com/css2?family=Dela+Gothic+One&family=Hachi+Maru+Pop&family=Kaisei+Decol&family=Noto+Sans+JP:wght@400;700&family=Potta+One&display=swap"
					rel="stylesheet"
				/>
				<script
            ...
            `}
				...
				{process.env.NEXT_PUBLIC_STATIC_EXPORT === "true" && (
					<meta
						httpEquiv="refresh"
						content="0; url=https://unj-reze.onjmin.workers.dev/"
					/>
				)}
			</head>
