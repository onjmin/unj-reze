	...
	return (
		<div className="fixed top-3 left-1/2 -translate-x-1/2 z-100 flex flex-col gap-2 items-center pointer-events-none w-full px-4">
			{toasts.map((t) => (
				<div
					key={t.id}
					className={`pointer-events-auto flex items-center gap-2 px-4 py-2.5 rounded-full shadow-lg backdrop-blur-md text-xs font-bold animate-fade-in-up max-w-[92vw] ${
						t.type === "error"
