...
export default function RightSidebar({ onSearch }: RightSidebarProps) {
	...
	return (
		<div
			id="right-sidebar"
			className="hidden lg:flex flex-col w-80 shrink-0 sticky top-0 h-screen scrollbar-none px-4 py-4 gap-4 border-l border-gray-800 select-none"
		>
			...
			{trends.length > 0 && (
				<div className="bg-[#0f1420] border border-gray-800 rounded-2xl overflow-hidden">
					<div className="px-4 py-3 font-bold text-base border-b border-gray-800">
						「いま」を見つけよう
					</div>
