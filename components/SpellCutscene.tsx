			...
			{isBoss ? (
				<div
					style={{
						...
						background:
							"linear-gradient(90deg, transparent 0%, rgba(153,27,27,0.8) 50%, rgba(220,38,38,0.9) 100%)",
				...
				<div
					style={{
						...
						background:
							"linear-gradient(90deg, rgba(30,58,138,0.9) 0%, rgba(29,78,216,0.8) 70%, transparent 100%)",
