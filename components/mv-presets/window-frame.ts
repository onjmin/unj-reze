...
const LAYERS: MvLayer[] = [
	...
	// 「鳴っていない音」と「鳴っている音」の差まで潰れて、全部が同じに光って見える。
	{
		...
		light: {
			dim: 0.12,
			fadeOut: true,
			echo: { beats: 0.5, spread: 5, thickness: 1 },
		},
...
export const WINDOW_FRAME_PRESET: MvPresetEntry = {
	...
	name: "窓のステージ",
	description:
		"黒地の中央にある白い窓の中身が8小節ごとに入れ替わり、周りに並ぶ影が増減する。右端には縦書き歌詞が10列ぶん積み上がる。",
	swapHint:
		"窓の中身（住人・灯り）をあなたのドット絵に差し替えるだけで一気に自分のものになります。窓の枠は図形レイヤーなので大きさも変えられます。",
