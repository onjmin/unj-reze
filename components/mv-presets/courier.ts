...
const LYRICS: MvLyricLine[] = [
	...
	{ bar: 20, text: "みなもの したに います" },
	{
		bar: 22,
		text: "つきも みえず なにもなく",
		marks: [{ from: 0, to: 2, color: MARK_MOON }],
	},
	{
		bar: 24,
		text: "かぜも ふかず",
		marks: [{ from: 0, to: 2, color: MARK_WIND }],
	},
	{
		bar: 26,
		text: "はなも ちらず",
		marks: [{ from: 0, to: 2, color: MARK_FLOWER }],
	},
	{ bar: 28, text: "もう なにも" },
...
export const COURIER_PRESET: MvPresetEntry = {
	...
	name: "運び屋（度数つき）",
	description:
		"カメラを動かさない駅のホーム。3人の頭の上にコードの度数が出て、歌詞は語ごとに色が敷かれる。終盤で画面全体が夕焼け色に変わる。",
	swapHint:
		"場面を増やさないのがこの見本の作りです。頭の上の数字は「レイヤー」タブの度数レイヤーで、どのトラックを読むか変えられます。",
