...
const SECTIONS: MvSection[] = [
	...
	},
	{
		...
		label: "間奏",
		startBar: 40,
		transition: { style: "wipeLeft", beats: 1 },
	},
	{
		id: "a3",
		label: "A″",
...
export const SEQUENCER_PRESET: MvPresetEntry = {
	...
	name: "シーケンサ",
	description:
		"黒地の大きなステップ格子。歌が入ると縦書き歌詞が右から列で積み上がり、8小節ごとに格子の幅と分割が組み替わる64小節構成。",
	swapHint:
		"素材は要りません。歌詞はMMLの歌詞トラック（@@n）から自動で同期します。格子の段数は「対象トラック」で増やせます。",
