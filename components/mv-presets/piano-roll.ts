...
function roll(
	...
	sections: string[],
	view: Partial<MvView>,
	over: Partial<MvVisualizerLayer> = {},
): MvVisualizerLayer {
	return {
		kind: "visualizer",
		id,
...
const SECTIONS: MvSection[] = [
	{ id: "intro", label: "イントロ（ロールだけ）", startBar: 0 },
	{
		...
		label: "本編",
		startBar: 8,
		transition: { style: "flash", beats: 2 },
	},
	{
		id: "a",
		label: "A（見下ろす）",
	...
	},
	{
		...
		stage: {
			bgColor: "#241b33",
			palette: ["#f0abfc", "#67e8f9", "#fde047", "#fb7185", "#c4b5fd"],
		},
	...
	},
	{
		...
		label: "アウトロ（平面）",
		startBar: 56,
		stage: { bgColor: "#0b1017" },
		transition: { style: "wipeRight", beats: 1.5 },
	},
];
...
const LAYERS: MvLayer[] = [
	...
	roll(
		"roll-sabi",
		["sabi"],
		{ pitch: 30, yaw: -34, fov: 64, depth: 330, thickness: 14 },
		{ amount: 4 },
	),
	...
	roll(
		...
		{},
		{
			...
			light: {
				dim: 0.5,
				fadeOut: false,
				echo: { beats: 0.6, spread: 8, thickness: 1.5 },
			},
		},
	),
...
export const PIANO_ROLL_PRESET: MvPresetEntry = {
	...
	swapHint:
		"背景に1枚絵を、右のキャラをあなたのドット絵に差し替えると一気に完成します。「場面」タブで視点が変わる小節数を調整できます。",
