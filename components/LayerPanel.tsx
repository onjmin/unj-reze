		...
		return (
			...
			>
				...
				<div className="p-1.5 border-t border-gray-700 shrink-0">
					<button
						onClick={onAdd}
						className="w-full flex items-center justify-center space-x-1.5 py-2 rounded-lg bg-gray-100/10 hover:bg-gray-100/20 text-gray-300 text-[11px] transition-colors"
					>
						<Plus size={14} />
						<span>レイヤーを追加</span>
					</button>
	...
	return (
		<div className="absolute inset-0 z-[60] flex flex-col bg-[#0f0f11]">
			...
			<div className="p-2 border-t border-gray-800 shrink-0">
				<button
					onClick={onAdd}
					className="w-full flex items-center justify-center space-x-1.5 py-2.5 rounded-lg bg-gray-100/10 hover:bg-gray-100/20 text-gray-300 text-xs transition-colors"
				>
					<Plus size={15} />
					<span>レイヤーを追加</span>
				</button>
		...
		>
			...
			>
				...
				{canDelete && (
					<button
						...
						className="p-1 text-red-400/50 hover:text-red-400 touch-none"
					>
						<Trash2 size={14} />
					</button>
				)}
			...
			{isActive && (
				<div className="flex items-center gap-2 px-2 pb-2 pt-0.5">
					<span className="text-[9px] text-gray-500 w-7 text-right shrink-0">
						{opacity}%
					</span>
					<input
						type="range"
