...
import { type DialogueLine, PLAY_H, PLAY_W } from "./game-presets/shared";
...
const DialogueCutscene = forwardRef<DialogueCutsceneHandle, Props>(
	function DialogueCutscene({ lines, onComplete }, ref) {
		...
		return (
			<div
				...
				style={{
					background:
						"linear-gradient(to top, rgba(0,0,0,0.72) 55%, transparent)",
				}}
				onClick={advance}
			>
				...
				<div className="absolute bottom-0 left-0 right-0 mx-2 mb-2">
					...
					>
						<p className="text-yellow-300 text-xs font-bold mb-1 leading-none">
							{current.speaker}
						</p>
						<p
