...
const foe = (o: {
	...
	spriteId?: string;
	isBoss?: boolean;
	outroDialogue?: PresetData["objects"][number]["outroDialogue"];
	...
	newObject({
		...
		hazard: true,
		isBoss: o.isBoss,
		encounterMax: o.encounterMax,
		outroDialogue: o.outroDialogue,
		miniScript: o.miniScript,
		dialogue: o.dialogue,
		...(o.spriteId
	...
	randomEncounters: [
		{
			...
			dialogue: [
				{
					text: "こっちに きたかったら かえずなくといいよ",
					actUsed: "Investigation",
					mercyAbovePct: 60,
				},
...
`.trim(),
	...
	encounterRate: 12,
	bgm: {
		ref: "https://www.youtube.com/watch?v=oHZDWwW6iXs",
		src: "https://www.youtube.com/watch?v=oHZDWwW6iXs",
		type: "youtube",
	},
	objects: [
		// ヤギのママ（いえ・回復とパイ）
		newObject({
			...
			behavior: "still",
			hazard: false,
			spriteRef: wr(SPR.toriel),
			spriteUrl: sa(SPR.toriel),
			pages: [
				{
					name: "パイをくれる",
					...
					commands: [
						{
							type: "message",
							text: "ママ「まあ…… ちいさな ニンゲンの子。\nけがは ない？ ここは あぶない ばしょよ」",
						},
						{
							type: "message",
							text: "ママ「おなかが すいたら これを おたべなさい。\n🥧 てづくりのパイ を もらった！」",
						},
		...
		// 宝物庫（右の部屋）
		chest(25, 14, [{ type: "giveItem", itemId: "monsterCandy", count: 2 }]),
		chest(26, 16, [{ type: "changeGold", amount: 30 }]),
		// 遺跡のモンスター
		foe({
			name: "カエルさん",
			emoji: "🐸",
			...
			pages: [
				...
				},
				{
					...
					commands: [
						{
							type: "message",
							text: "ママ「……この扉のむこうは もっと あぶない せかいよ。\nどうしても 行くというなら——」",
						},
						{
							type: "message",
							text: "ママ「ママを こえて いきなさい！\n（こうどう で 敵意をなくせば みのがしてもらえる…）」",
						},
						{ type: "setSelfSwitch", id: "A", value: true },
					],
				},
...
const sceneSnowdin: SceneDef = {
	...
	encounterRate: 10,
	bgm: {
		ref: "https://www.youtube.com/watch?v=vYyLL9QstbI",
		src: "https://www.youtube.com/watch?v=vYyLL9QstbI",
		type: "youtube",
	},
	objects: [
		// ホネの兄弟
		npc(
			...
			5,
			13,
			"よう にんげん。ほねのある やつは きらいじゃないぜ。……おっと、おれの ことか。",
			SPR.sans,
		),
		foe({
			name: "ハデなガイコツ",
			...
			dialogue: [
				{
					text: "こっちの チームに いられるのは おまえだけじゃないぜ",
					actUsed: "Investigation",
					mercyAbovePct: 60,
				},
				{ text: "おい なに じろじろ みてやがる", actUsed: "はなす" },
				{
					text: "フン…… なに おだますようなこと いいやがる",
					actUsed: "ほめる",
				},
...
`.trim(),
		...
		newObject({
			...
			behavior: "still",
			hazard: false,
			spriteRef: ir(DECO.sign),
			spriteUrl: sp(DECO.sign),
			pages: [
				{
					conditions: {},
					commands: [
		...
		foe({
			...
			gold: 14,
			behavior: "patrolH",
			spriteId: SPR.dogKnight,
			dialogue: [
				{
					text: "……おまえの なかまに なるのはちょっと……",
					actUsed: "Investigation",
					mercyAbovePct: 60,
				},
		...
		newObject({
			...
			behavior: "still",
			hazard: false,
			spriteRef: wr(SPR.snowman),
			spriteUrl: sa(SPR.snowman),
			pages: [
				{
					conditions: { selfSwitchId: "A", selfSwitchValue: true },
					commands: [
						{
							type: "message",
							text: "スノーマン「とおくへ つれていってくれて ありがとう…」",
						},
					],
				},
				{
					...
					commands: [
						{
							type: "message",
							text: "スノーマン「ぼくは ここから うごけないんだ。\nぼくの かけらを とおくへ つれていって くれない？」",
						},
						{
							type: "message",
							text: "⛄スノーマンのかけら を もらった！（たべると HP回復）",
						},
		...
		newObject({
			...
			behavior: "still",
			hazard: false,
			spriteRef: wr(SPR.bunny),
			spriteUrl: sa(SPR.bunny),
			pages: [
				{
					conditions: {},
					commands: [
						{
							type: "choice",
							text: "宿屋うさぎ「いらっしゃい！ ひとばん 20ゴールドだよ」",
							choices: [
								{
									label: "とまる（20G）",
									commands: [
										{
											...
											then: [
												...
												{
													type: "message",
													text: "ふかふかの ベッドで ぐっすり ねむった。\nHPとMPが 全回復した！",
												},
											],
											else: [
												{
													type: "message",
													text: "宿屋うさぎ「ごめんね、お金が たりないみたい」",
												},
											],
										},
									],
		...
		newObject({
			...
			behavior: "still",
			hazard: false,
			spriteRef: ir(DECO.counter),
			spriteUrl: sp(DECO.counter),
			shopItems: [
			...
			pages: [
				{
					...
					commands: [
						{
							type: "message",
							text: "店番うさぎ「いらっしゃい。ドーナツは クモの巣まで\nとどけてくれる ふしぎな おかしだよ」",
						},
					],
				},
			],
		...
		npc(
			...
			23,
			17,
			"このまちの ガイコツ兄弟は ゆうめい人でね。おとうとは ジョークずき、おにいさんは パズルずきさ。",
			SPR.bunnyTown,
		),
		// ワープ
...
const sceneWaterfall: SceneDef = {
	...
	randomEncounters: [
		...
		},
		{
			...
			dialogue: [
				{
					text: "え！？ テミーの なかまになりてぇの？ やばっ！",
					actUsed: "Investigation",
					mercyAbovePct: 60,
				},
				{ text: "ちょっと！ もうちょっと みてよ！", actUsed: "はなす" },
				{
					text: "えへへ…… テミーは かわいいに決まってるの！",
					actUsed: "ほめる",
				},
	...
	encounterRate: 8,
	bgm: {
		ref: "https://www.youtube.com/watch?v=DVUh7caufKU",
		src: "https://www.youtube.com/watch?v=DVUh7caufKU",
		type: "youtube",
	},
	objects: [
		// ゆううつなゴースト
		npc(
			...
			6,
			3,
			"や… ぼく ここで ねそべってるんだ… ゴミになった きぶんで…… …じゃまだったら ごめん…",
			SPR.ghost,
		),
		// エコーフラワー
		npc(
		...
		newObject({
			...
			behavior: "still",
			hazard: false,
			spriteRef: wr(SPR.temmie),
			spriteUrl: sa(SPR.temmie),
			shopItems: [
		...
		// 宝箱
		chest(26, 3, [{ type: "giveItem", itemId: "burntPan", count: 1 }]),
		chest(2, 14, [{ type: "giveItem", itemId: "tutu", count: 1 }]),
		// どうくつのモンスター
		foe({
			name: "うたうさかな",
			emoji: "🐟",
		...
		foe({
			...
			dialogue: [
				{
					text: "ここは まもるべき ばしょなんだ…… いけない",
					actUsed: "Investigation",
					mercyAbovePct: 60,
				},
				{
					text: "ふん！ なんの ひつようもない こうどうだ！",
					actUsed: "はなす",
				},
...
const sceneNewHome: SceneDef = {
	...
	map: newHomeMap,
	bgm: {
		ref: "https://www.youtube.com/watch?v=1HIKNbnV8nw",
		src: "https://www.youtube.com/watch?v=1HIKNbnV8nw",
		type: "youtube",
	},
	objects: [
		// はなのケモノ、再登場
		...
		newObject({
			...
			behavior: "still",
			hazard: false,
			spriteRef: ir(DECO.table),
			spriteUrl: sp(DECO.table),
			pages: [
				{
					conditions: { selfSwitchId: "A", selfSwitchValue: true },
					commands: [],
				},
				{
					...
					commands: [
						{
							type: "message",
							text: "はなばたけの おくから おだやかな こえがする……\n王「ようこそ。ちいさな ひとよ。\nお茶でも いれたいところ なのだけど……」",
						},
						{
							type: "choice",
							text: "王「たたかいたくは ない。それでも きみは すすむかい？」",
							choices: [
								{
									label: "すすむ",
									commands: [
...
`.trim(),
			...
			outroDialogue: [
				...
				},
				{
					speaker: "おうさま",
					emoji: "🐐",
					text: "ちじょうへ つづく とびらは この おくに ある。\n……すきに しなさい。",
				},
				{
					speaker: "ニンゲン",
					emoji: "🧒",
					side: "right",
					text: "…… みんなも いっしょに いこうよ。",
				},
				{
					speaker: "はなのケモノ",
					emoji: "🌼",
...
export const undertale: PresetData = {
	...
	player: {
		...
		spriteRef: wr(SPR.human),
		spriteUrl: sa(SPR.human),
	},
	tiles,
	...
	items: [
		{
			...
			name: "モンスターキャンディ",
			emoji: "🍬",
			description: "HPを 14 回復する。ちょっと しょっぱい",
			category: "consumable",
			healHp: 14,
		},
		{
			...
			name: "スパイダードーナツ",
			emoji: "🍩",
			description: "HPを 24 回復する。クモが つくった",
			category: "consumable",
			healHp: 24,
		},
		{
			...
			name: "スノーマンのかけら",
			emoji: "⛄",
			description: "HPを 30 回復する。たべると すこし つめたい",
			category: "consumable",
			healHp: 30,
		},
		{
			...
			name: "インスタントめん",
			emoji: "🍜",
			description: "HPを 45 回復する。なま でも いける",
			category: "consumable",
			healHp: 45,
		},
		{
			...
			name: "てづくりのパイ",
			emoji: "🥧",
			description: "HPを 99 回復する。ママの あじ",
			category: "consumable",
			healHp: 99,
		},
		{
		...
		},
		{
			...
			name: "ゴツいてぶくろ",
			emoji: "🥊",
			description: "ピンクの ごつい てぶくろ。こうげき力＋14",
			category: "weapon",
			atkBonus: 14,
		},
		{
		...
		},
		{
			...
			name: "ふるびたリボン",
			emoji: "🎀",
			description: "かわいいと 攻撃されにくい。しゅび力＋6",
			category: "armor",
			defBonus: 6,
		},
		{
			...
			name: "おとこらしいバンダナ",
			emoji: "🥋",
			description: "きんにくの絵が かいてある。しゅび力＋13",
			category: "armor",
			defBonus: 13,
		},
		{
			...
			name: "ふるびたチュチュ",
			emoji: "🩰",
			description: "ひらり と かわせそう。しゅび力＋18",
			category: "armor",
			defBonus: 18,
		},
		{
			...
			name: "テミーのよろい",
			emoji: "🛡️",
			description: "テミーかがくの けっしょう。しゅび力＋28",
			category: "armor",
			defBonus: 28,
		},
	],
	titleScreen: {
		...
		textColor: "#ffffff",
		menu: [{ kind: "newGame", label: "けつい を むねに はじめる" }],
	},
	ending: {
		enabled: true,
		heading: "THE END",
	...
	battleBgm: {
		ref: "https://www.youtube.com/watch?v=g6aia0GQMRw",
		src: "https://www.youtube.com/watch?v=g6aia0GQMRw",
		type: "youtube",
	},
	bossBgm: {
		ref: "https://www.youtube.com/watch?v=42kI2lT0x6U",
		src: "https://www.youtube.com/watch?v=42kI2lT0x6U",
		type: "youtube",
	},
	sfx: {
		levelup: {
			ref: `direct:${undertaleSfxUrl("snd_level_up")}`,
			src: undertaleSfxUrl("snd_level_up"),
			type: "direct" as const,
		},
		purchase: {
			ref: `direct:${undertaleSfxUrl("snd_menu_confirm")}`,
			src: undertaleSfxUrl("snd_menu_confirm"),
			type: "direct" as const,
		},
		inn: {
			ref: `direct:${undertaleSfxUrl("snd_item_heal")}`,
			src: undertaleSfxUrl("snd_item_heal"),
			type: "direct" as const,
		},
		save: {
			ref: `direct:${undertaleSfxUrl("snd_save")}`,
			src: undertaleSfxUrl("snd_save"),
			type: "direct" as const,
		},
		damage: {
			ref: `direct:${undertaleSfxUrl("snd_hurt")}`,
			src: undertaleSfxUrl("snd_hurt"),
			type: "direct" as const,
		},
		clear: {
			ref: `direct:${undertaleSfxUrl("snd_logo")}`,
			src: undertaleSfxUrl("snd_logo"),
			type: "direct" as const,
		},
	},
};
