...
const sceneField: SceneDef = {
  ...
  randomEncounters: [
    { name: 'スライム',     emoji: '🟦', hp: 8,  atk: 9,  def: 2, exp: 3,  gold: 4  },
    { name: 'スライム',     emoji: '🟦', hp: 8,  atk: 9,  def: 2, exp: 3,  gold: 4  },
    { name: 'スライムベス', emoji: '🟥', hp: 12, atk: 11, def: 3, exp: 5,  gold: 7  },
    { name: 'ドラキー',     emoji: '🦇', hp: 14, atk: 13, def: 4, exp: 7,  gold: 10 },
    { name: 'ゴースト',     emoji: '👻', hp: 18, atk: 16, def: 6, exp: 10, gold: 14 },
    { name: 'まどうし',     emoji: '🧙', hp: 24, atk: 18, def: 8, exp: 15, gold: 22, moves: [{ name: 'ギラ', power: 12 }] },
  ],
  encounterRate: 15,
  bgm: { ref: 'https://www.youtube.com/watch?v=9rWBQNDlNW4', src: 'https://www.youtube.com/watch?v=9rWBQNDlNW4', type: 'youtube' },
  objects: [
    // ── 南部（弱い敵）──
    foe({ name: 'スライム', emoji: '🟦', col: 12, row: 14, hp: 8, atk: 9, def: 2, exp: 3, gold: 4, behavior: 'random', speed: 1.0, spriteId: 'k3vKh6' }),
    foe({ name: 'スライム', emoji: '🟦', col: 17, row: 20, hp: 8, atk: 9, def: 2, exp: 3, gold: 4, behavior: 'random', speed: 1.0, spriteId: 'k3vKh6' }),
    foe({ name: 'スライムベス', emoji: '🟥', col: 25, row: 13, hp: 12, atk: 11, def: 3, exp: 5, gold: 7, behavior: 'random', speed: 1.0, spriteId: 'hswBaA' }),
    // ── 北部（強い敵）──
    foe({ name: 'ドラキー', emoji: '🦇', col: 8, row: 7, hp: 14, atk: 13, def: 4, exp: 7, gold: 10, behavior: 'random', spriteId: 'R42ett' }),
    foe({ name: 'がいこつ', emoji: '💀', col: 16, row: 6, hp: 32, atk: 26, def: 12, exp: 24, gold: 30, behavior: 'patrolH', spriteId: 'pyPkIs' }),
    foe({ name: 'おおさそり', emoji: '🦂', col: 22, row: 7, hp: 36, atk: 30, def: 14, exp: 33, gold: 40, behavior: 'random' }),
    foe({ name: 'よろいのきし', emoji: '🤺', col: 23, row: 6, hp: 70, atk: 48, def: 26, exp: 95, gold: 110, behavior: 'patrolV' }),
    // ── NPC ──
...
const sceneCave: SceneDef = {
  ...
  map: caveMap,
  randomEncounters: [
    { name: 'メーダ',     emoji: '👁️', hp: 24, atk: 21, def: 9,  exp: 16, gold: 20, moves: [{ name: 'メラ', power: 11 }] },
    { name: 'がいこつ',   emoji: '💀', hp: 32, atk: 26, def: 12, exp: 24, gold: 30 },
    { name: 'まどうし',   emoji: '🧙', hp: 28, atk: 24, def: 10, exp: 28, gold: 36, moves: [{ name: 'ギラ', power: 14 }, { name: 'ホイミ', power: 18, heal: true }] },
    { name: 'おおさそり', emoji: '🦂', hp: 36, atk: 30, def: 14, exp: 33, gold: 40 },
    { name: 'リカント',   emoji: '🐺', hp: 42, atk: 34, def: 15, exp: 40, gold: 48 },
  ],
  encounterRate: 11,
  ...
  objects: [
    ...
    // ── 隠し部屋（まほうのよろい）──
    foe({ name: 'がいこつ', emoji: '💀', col: 11, row: 17, hp: 32, atk: 26, def: 12, exp: 24, gold: 30, behavior: 'patrolH', spriteId: 'pyPkIs' }),
    newObject({
    ...
    // ── 右の通路と最深部 ──
    foe({ name: 'メーダ', emoji: '👁️', col: 26, row: 9, hp: 24, atk: 21, def: 9, exp: 16, gold: 20, moves: [{ name: 'メラ', power: 11 }], behavior: 'patrolV', spriteId: 'oE4l1x' }),
    // 番人ドラゴン
...
const sceneDragonCastle: SceneDef = {
  ...
  map: dragonCastleMap,
  randomEncounters: [
    { name: 'キメラ',       emoji: '🦅', hp: 46, atk: 40, def: 16, exp: 60, gold: 70,  moves: [{ name: 'かえんのいき', power: 20 }] },
    { name: 'しりょうのきし', emoji: '🧟', hp: 55, atk: 44, def: 22, exp: 75, gold: 85,  moves: [{ name: 'ベホイミ', power: 25, heal: true }] },
    { name: 'だいまどう',   emoji: '🔮', hp: 48, atk: 42, def: 18, exp: 85, gold: 105, moves: [{ name: 'ベギラマ', power: 30 }] },
    { name: 'よろいのきし', emoji: '🤺', hp: 70, atk: 48, def: 26, exp: 95, gold: 110 },
  ],
  encounterRate: 10,
  bgm: { ref: 'https://www.youtube.com/watch?v=kpXqFuFe5pM', src: 'https://www.youtube.com/watch?v=kpXqFuFe5pM', type: 'youtube' },
  objects: [
    ...
    // ── 大広間 ──
    foe({ name: 'しりょうのきし', emoji: '🧟', col: 10, row: 7, hp: 55, atk: 44, def: 22, exp: 75, gold: 85, moves: [{ name: 'ベホイミ', power: 25, heal: true }], behavior: 'patrolH' }),
    foe({ name: 'キメラ', emoji: '🦅', col: 19, row: 8, hp: 46, atk: 40, def: 16, exp: 60, gold: 70, moves: [{ name: 'かえんのいき', power: 20 }], behavior: 'random' }),
    // 西翼：ロトのつるぎ（ストーンマンが守る）
