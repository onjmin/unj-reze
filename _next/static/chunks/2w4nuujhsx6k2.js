(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,22216,e=>{e.q("/unj-reze/_next/static/media/voice-worker.0-2eet5p8gboy.js")},48605,e=>{"use strict";let t,o,a,r,n,l;var A,u,i,s,d,c,g,m=`0000 Acoustic Grand Piano
  ...
  <div class="dtm-modal-overlay" data-dtm="modal-overlay" hidden>
    <div class="dtm-win dtm-modal">
...
</div>`;let A=e.querySelector('[data-dtm="root"]'),u=e=>{let t;return t=`[data-dtm="${e}"]`,A.querySelector(t)};return{root:A,topbar:u("transport"),topbarLoading:u("topbar-loading"),playBtn:u("play"),prevBarBtn:u("prev-bar"),nextBarBtn:u("next-bar"),soloCheckbox:u("solo"),toolPen:u("tool-pen"),toolSelect:u("tool-select"),toolEraser:u("tool-eraser"),undoBtn:u("undo"),redoBtn:u("redo"),noteLengthSelect:u("note-length"),bpmInput:u("bpm"),zoomXLabel:u("zoomx-label"),zoomYLabel:u("zoomy-label"),zoomXIn:u("zoomx-in"),zoomXOut:u("zoomx-out"),zoomYIn:u("zoomy-in"),zoomYOut:u("zoomy-out"),rollContainer:u("roll"),wrapper:u("wrapper"),vScroll:u("vscroll"),vScrollThumb:u("vscroll-thumb"),hScroll:u("hscroll"),hScrollThumb:u("hscroll-thumb"),masterVolume:u("master-volume"),masterVolumeLabel:u("master-volume-label"),trackTabs:u("track-tabs"),trackBody:u("track-body"),drumSelect:u("drum-select"),drumVolume:u("drum-volume"),drumVolumeLabel:u("drum-volume-label"),midiInput:u("midi-input"),midiLoadBtn:u("midi-load"),midiInfoBtn:u("midi-info"),midiTrackSelection:u("midi-track-selection"),midiPanel:u("midi-panel"),mmlInput:u("mml-input"),mmlLoadBtn:u("mml-load"),mmlLoadNote:u("mml-load-note"),shiftSelect:u("shift-select"),shiftApplyBtn:u("shift-apply"),macroClear:u("macro-clear"),macroRandom:u("macro-random"),macroHarmonic:u("macro-harmonic"),macroMono:u("macro-mono"),exportMidiBtn:u("export-midi"),generateMmlBtn:u("generate-mml"),decomposeChordToggle:u("decompose-chord"),ignoreChordHeavyToggle:u("ignore-chord-heavy"),barLimitSelect:u("bar-limit"),outputContainer:u("output-container"),outputStatus:u("output-status"),outputFull:u("output-full"),outputMini:u("output-mini"),copyFullBtn:u("copy-full"),copyMiniBtn:u("copy-mini"),overlay:u("overlay"),mmlInfoBtn:u("mml-info"),modalOverlay:u("modal-overlay"),modalTitle:u("modal-title"),modalBody:u("modal-body"),modalClose:u("modal-close")}})(e,{tracks:f,drumPatternNames:Object.keys(v),defaultDrumPattern:v.dance?"dance":Object.keys(v)[0]??"none",defaultBpm:t.defaultBpm??120,showMidi:y,showChord:b}),F={stepsPerBar:192,keyCount:128,pitchRangeStart:0,keyHeight:15,stepWidth:1},k=100,x=100,D=t.defaultBpm??120,M=50,S=80,L=w.drumSelect.value,R="",N=t.initialActiveTrack??f[0].id,T="pen",U=48,P=12,J=0,K=t.initialScrollPitch??48,H=(F.keyCount-1-K)*F.keyHeight-215,O=0,G=!1,Y=new Set,V="stopped",z=0,X=0,W=!1,j=!1,Z=[],$=null,_=[],ee=[],et=!1,eo=null,ea=e=>{if(!t.onLyricsChange)return;let o=e.config.id,a={lyrics:e.lyrics,model:e.lyricModel,vocalVolume:e.vocalVolume,vocalGate:e.vocalGate,vocalPan:e.vocalPan,vocalOctave:e.vocalOctave};eo&&clearTimeout(eo),eo=setTimeout(()=>{t.onLyricsChange?.(o,a),eo=null},300)},er=new Set,en=new Set,el=()=>ee.find(e=>e.config.id===N)??ee[0],eA=()=>{let e=0;for(let t of ee)for(let o of t.core.getNotes()){let t=o.startStep+o.durationSteps;t>e&&(e=t)}return 0===e?4*F.stepsPerBar:(Math.floor((e-1)/F.stepsPerBar)+2)*F.stepsPerBar},eu=()=>{let e=i;return Math.max(0,eA()*F.stepWidth-e.width)},ei=()=>Math.max(0,F.keyCount*F.keyHeight-i.height),es=()=>{for(let e of(((e=1)=>{ti(),ts(),c.clearRect(0,0,i.width,i.height);let{keyHeight:t,keyCount:o,stepWidth:a,stepsPerBar:r,pitchRangeStart:n}=g,l=Math.floor(tn/t)*t,A=tn+i.height;for(let e=l;e<A;e+=t){let a=o-1-e/t,r=a+n,l=a%12,A=tA.has(l),u=0===l,s=4==Math.floor(r/12)-1,d=e-tn;c.fillStyle=A?"#080b16":"#111628",c.fillRect(0,d,i.width,t),s&&(c.fillStyle="rgba(41,173,255,0.05)",c.fillRect(0,d,i.width,t)),c.beginPath(),c.strokeStyle=u?"#3d405b":"#1a1d30",c.lineWidth=1;let g=d+t;c.moveTo(0,g),c.lineTo(i.width,g),c.stroke()}let u=e||48,s=Math.floor(tr/(a*u))*a*u,d=tr+i.width,m=a*u;for(let e=s;e<=d;e+=m){let t=e/a,o=t%r==0,n=t%u==0,l=e-tr;c.beginPath(),c.strokeStyle=o?"#3d405b":n?"#242840":"#1a1d30",c.lineWidth=o?2:1,c.moveTo(l,0),c.lineTo(l,i.height),c.stroke()}})(48),ee)){if(er.has(e.config.id)||G&&e.config.id!==N)continue;let[t,o,a]=e.config.color,r=e.config.id===N?1:.3;td(e.core.getNotes(),[t,o,a,r])}if("select"===T&&$){let e=c;e.save(),e.strokeStyle="#ffec27",e.lineWidth=2,e.setLineDash([4,4]),e.strokeRect($.x,$.y,$.width,$.height),e.fillStyle="rgba(255,236,39,0.08)",e.fillRect($.x,$.y,$.width,$.height),e.restore()}if("select"===T&&Z.length>0){let e=new Set(Z.map(e=>e.id)),t=el();((e,t,o=[59,130,246,1])=>{let{keyHeight:a,stepWidth:r,keyCount:n,pitchRangeStart:l}=g;for(let A of e){if(!t.has(A.id))continue;let e=A.startStep*r,u=(n-1-(A.pitch-l))*a,i=A.durationSteps*r,s=e-tr,d=u-tn,g=void 0!==A.velocity?.5+A.velocity/127*.5:1,[m,p,C,h]=o,B=Math.min(255,1.3*m),E=Math.min(255,1.3*p),f=Math.min(255,1.3*C),Q=h*g;c.fillStyle=`rgba(${B},${E},${f},${Q})`,c.fillRect(s+1,d+1,i-2,a-2)}})(t.core.getNotes(),e,[...t.config.color,1])}(()=>{let e=c,t=i;if(!e)return;let o=O*F.stepWidth-J;o<-10||o>t.width+10||(e.save(),e.strokeStyle="#ffec27",e.lineWidth=2,e.setLineDash([4,4]),e.beginPath(),e.moveTo(o,0),e.lineTo(o,t.height),e.stroke(),e.restore())})(),"playing"===V&&(()=>{let e=c,t=i;if(!e)return;let o=X*F.stepWidth-J;o<0||o>t.width||(e.save(),e.strokeStyle="#ff004d",e.lineWidth=2,e.beginPath(),e.moveTo(o,0),e.lineTo(o,t.height),e.stroke(),e.restore())})(),ed()},ed=()=>{let e=i,t=eu(),o=w.hScroll.clientWidth;if(t<=0)w.hScrollThumb.style.width="100%",w.hScrollThumb.style.left="0";else{let a=eA()*F.stepWidth,r=Math.max(40,e.width/a*o),n=J/t;w.hScrollThumb.style.width=`${r}px`,w.hScrollThumb.style.left=`${tW(n*(o-r),0,o-r)}px`}let a=F.keyCount*F.keyHeight,r=w.vScroll.clientHeight;if(a<=e.height)w.vScrollThumb.style.height="100%",w.vScrollThumb.style.top="0";else{let t=Math.max(40,e.height/a*r),o=ei(),n=H/o;w.vScrollThumb.style.height=`${t}px`,w.vScrollThumb.style.top=`${n*(r-t)}px`}},ec=!1,eg=!1,em=null,eC=!1,eE="rect",ef=null,eQ=[],eI=null,ev=e=>{if(j)return;t.onResumeAudio?.();let o=el();eT(o.config.id,e,o.volume,100,0,.5)},ey=(e,t,o=0)=>{let a=el(),{stepWidth:r,keyHeight:n,keyCount:l,pitchRangeStart:A}=F,u=tl();for(let i of a.core.getNotes()){let a=i.startStep*r,s=(l-1-(i.pitch-A))*n,d=i.durationSteps*r,c=a-u.x,g=s-u.y;if(e>=c-o&&e<=c+d+o&&t>=g-o&&t<=g+n+o)return i}return null},eb=()=>t.lockedTracks?.includes(el().config.id)??!1,eF=e=>{e.preventDefault(),t.onResumeAudio?.();let{x:o,y:a,step:r,pitch:n}=tc(e),l=el();if("eraser"===T){if(eb())return;let e=ey(o,a);e&&l.core.deleteNoteById(e.id);return}if("select"===T){if(Z.length>0){let e=ey(o,a);if(e&&Z.some(t=>t.id===e.id)){eQ=Z.map(e=>({id:e.id,startStep:e.startStep,pitch:e.pitch})),eC=!0,eE="move",ef={x:o,y:a,step:r,pitch:n},eg=!1,eI=null;return}Z=[],$=null}let e=ey(o,a);e?(Z=[e],eQ=[{id:e.id,startStep:e.startStep,pitch:e.pitch}],eC=!0,eE="move"):(Z=[],$=null,eC=!0,eE="rect"),ef={x:o,y:a,step:r,pitch:n},eg=!1;return}eg=!1;let A=ey(o,a,6);if(A){ev(A.pitch);let{stepWidth:e}=F,t=tl(),a=A.startStep*e-t.x,l=A.durationSteps*e;em=o>=a+l-10&&o<=a+l?{noteId:A.id,mode:"resize",dragOffsetStep:0,dragOffsetPitch:0,startStep:A.startStep,durationSteps:A.durationSteps,lastPreviewPitch:A.pitch}:{noteId:A.id,mode:"move",dragOffsetStep:r-A.startStep,dragOffsetPitch:n-A.pitch,startStep:A.startStep,durationSteps:A.durationSteps,lastPreviewPitch:A.pitch},ec=!0;return}if(eb())return;let u=Math.floor(r/U)*U,i=u+U;if(!l.core.getNotes().some(e=>e.pitch===n&&u<e.startStep+e.durationSteps&&i>e.startStep)){l.core.addNote(u,n,{noteLengthSteps:U}),ev(n);let e=l.core.getNotes().find(e=>e.startStep===u&&e.pitch===n);e&&(em={noteId:e.id,mode:"move",dragOffsetStep:0,dragOffsetPitch:0,startStep:e.startStep,durationSteps:e.durationSteps,lastPreviewPitch:e.pitch},eg=!0),ec=!0}},ek=e=>{let t=el();if("pen"===T){if(!em)return;let{step:a,pitch:r}=tc(e);if(eg=!0,"move"===em.mode){var o;let e=Math.round((a-em.dragOffsetStep)/P)*P,n=r-em.dragOffsetPitch;if(o=em.noteId,el().core.getNotes().some(t=>t.id!==o&&t.pitch===n&&e>=t.startStep&&e<t.startStep+t.durationSteps))return;t.core.moveNote(em.noteId,e,n),n!==em.lastPreviewPitch&&(em.lastPreviewPitch=n,ev(n));return}let n=Math.max(Math.round((a-em.startStep+1)/P)*P,P);t.core.resizeNote(em.noteId,n),em.durationSteps=n,U=n,es();return}if("select"===T&&eC&&ef){let{x:o,y:a,step:r,pitch:n}=tc(e);if("rect"===eE){let e={x:Math.min(o,ef.x),y:Math.min(a,ef.y),width:Math.abs(o-ef.x),height:Math.abs(a-ef.y)};$=e;let{stepWidth:r,keyHeight:n,keyCount:l,pitchRangeStart:A}=F,u=tl();Z=t.core.getNotes().filter(t=>{let o=t.startStep*r,a=l-1-(t.pitch-A),i=o-u.x,s=a*n-u.y,d=t.durationSteps*r;return e.x<i+d&&e.x+e.width>i&&e.y<s+n&&e.y+e.height>s}),es()}else{let e=Math.round((r-ef.step)/P)*P,o=n-ef.pitch;if(0!==e||0!==o){for(let a of(eg=!0,t.core.isBatchOperation||t.core.beginBatch(),Z)){let r=eQ.find(e=>e.id===a.id);if(!r)continue;let n=r.pitch+o;n>=0&&n<128&&t.core.moveNote(a.id,r.startStep+e,n)}if(Z.length>0){let e=Z[0],t=eQ.find(t=>t.id===e.id);if(t){let e=t.pitch+o;e!==eI&&e>=0&&e<128&&(eI=e,ev(e))}}}es()}}},ex=()=>{if("pen"===T&&em){if(eg){let e=el();"move"===em.mode?e.core.moveNoteEnd(em.noteId):e.core.resizeNoteEnd(em.noteId),ec=!0}em=null,eg=!1}"select"===T&&eC&&(eg&&"move"===eE&&Z.length>0&&el().core.endBatch(),eC=!1,ef=null,eg=!1,eI=null,$=null,eQ=[],es())},eD=()=>{let e=w.rollContainer.clientWidth||800,t=w.rollContainer.clientHeight||450;((e,t=800,o=450,a)=>{g=a;let r=document.createElement("canvas");A=r,r.width=t-60,r.height=20,r.style.position="absolute",r.style.left="60px",r.style.top="0px";let n=r.getContext("2d");if(!n)throw Error("Failed to get 2D rendering context for header.");s=n;let l=document.createElement("canvas");u=l,l.width=60,l.height=o-20,l.style.position="absolute",l.style.left="0px",l.style.top="20px";let m=l.getContext("2d");if(!m)throw Error("Failed to get 2D rendering context for keyboard.");d=m;let p=document.createElement("canvas");i=p,p.width=t-60,p.height=o-20,p.style.position="absolute",p.style.left="60px",p.style.top="20px",p.style.touchAction="none";let C=p.getContext("2d",{willReadFrequently:!0});if(!C)throw Error("Failed to get 2D rendering context for grid.");c=C,e.innerHTML="",e.style.position="relative",e.style.width=`${t+60}px`,e.style.height=`${o}px`,e.append(r,l,p),(()=>{let e=u.parentElement;if(!e)return;let t=e.querySelector("#header-corner");t||((t=document.createElement("div")).id="header-corner",t.style.position="absolute",t.style.left="0px",t.style.top="0px",t.style.width="60px",t.style.height="20px",t.style.backgroundColor="#0a0f1f",t.style.borderRight="2px solid #29adff",t.style.borderBottom="2px solid #29adff",e.insertBefore(t,A))})()})(w.wrapper,e,t,F);let o=i;o.addEventListener("pointerdown",eF),o.addEventListener("dblclick",e=>{if(e.preventDefault(),eb())return;let{step:t,pitch:o}=tc(e),a=el(),r=a.core.getNotes().find(e=>e.pitch===o&&t>=e.startStep&&t<e.startStep+e.durationSteps);r&&a.core.deleteNoteById(r.id)}),o.addEventListener("wheel",e=>{e.preventDefault(),H=tW(H+e.deltaY,0,ei()),tg(J=tW(J+e.deltaX,0,eu()),H),es()},{passive:!1}),o.addEventListener("click",()=>{ec&&(ec=!1)});let a=A;a.addEventListener("click",e=>{if("playing"===V)return;let t=a.getBoundingClientRect();O=Math.max(0,Math.floor(Math.floor((e.clientX-t.left+J)/F.stepWidth)/P)*P),"paused"===V&&(V="stopped",eO()),es()}),tg(J,H),es()},eS=()=>{let e=i,t=(J+e.width/2)/F.stepWidth;F.stepWidth=2*k*.5/100,w.zoomXLabel.textContent=`${k}%`,tg(J=tW(t*F.stepWidth-e.width/2,0,eu()),H),es()},eL=()=>{let e=i,t=(H+e.height/2)/F.keyHeight;F.keyHeight=15*x/100,w.zoomYLabel.textContent=`${x}%`,H=tW(t*F.keyHeight-e.height/2,0,ei()),tg(J,H),es()},eR=()=>({zoomX:k,zoomY:x,decomposeChord:w.decomposeChordToggle.checked,ignoreChordHeavy:w.ignoreChordHeavyToggle.checked}),eN=()=>t.onViewStateChange?.(eR()),eT=(e,o,a,r,n,l)=>{let A=a/100*(r/127)*(M/100);t.onPlayNote?.({trackId:e,pitch:o,velocity:r,volume:A,when:n,duration:l})},eJ=tb({getTracks:()=>ee.map(e=>({id:e.config.id,volume:e.volume,notes:e.core.getNotes()})),getBpm:()=>D,getPlayStartStep:()=>O,getDrumPattern:()=>v[L]??null,getSoloTrackId:()=>G?N:null,getAudioTime:E,onPlayNote:e=>{if(en.has(e.trackId))return;let o=ee.findIndex(t=>t.config.id===e.trackId);o>=0&&Y.has(o)&&t.singingVoices||t.onPlayNote?.({...e,volume:e.volume*(M/100)})},onPlayDrum:e=>{let o=e.velocity*(S/100)*(M/100);t.onPlayDrum?.({...e,velocity:o})},onTick:e=>{X=e;let t=i.width/F.stepWidth,o=J/F.stepWidth+t-4;if(X>o){let e=Math.round(t/F.stepsPerBar);tg(J=tW(J+e*F.stepsPerBar*F.stepWidth,0,eu()),H)}es()},onEnd:e=>{e?(V="paused",z=X):(V="stopped",X=0),eO(),es()},stepsPerBar:F.stepsPerBar}),eK=async()=>{let e;if("playing"===V)return;await t.onResumeAudio?.();let o="paused"===V?z:O;t.singingVoices?.reset();let a=(e=new Map,ee.forEach((t,o)=>{let a=t.lyricModel.trim(),r=t.lyrics.trim();if(!a||!r)return;let n=eM(r);0!==n.length&&e.set(o,{trackId:o,model:a.toLowerCase(),volume:t.vocalVolume,gate:t.vocalGate,pan:t.vocalPan,octave:t.vocalOctave,syllables:n})}),e);Y=new Set(a.keys());let r=60/D/48,n=t.singingVoices?[...a.values()].map(e=>{let t=ee[e.trackId],a=[...t?.core.getNotes()??[]].sort((e,t)=>e.startStep-t.startStep),n=(e.gate??100)/100,l=(e.octave??0)*12,A=Math.min(a.length,e.syllables.length),u=[];for(let t=0;t<A;t++){let A=a[t];A.startStep<o||u.push({syllable:e.syllables[t],pitch:A.pitch+l,startSec:(A.startStep-o)*r,durationSec:A.durationSteps*r*n})}return{id:t?.config.id,model:e.model,volume:eU(e.volume??200)*(M/100),pan:eP(e.pan??64),notes:u}}):[],l=t.singingVoices,A=!!l&&n.some(e=>e.notes.length>0);if(A&&l){let e=tx(w.rollContainer);tF(!0);try{await l.loadModels(n.map(e=>e.model)),await l.warm(n)}catch(e){console.warn("[dtm] voice preload failed",e)}finally{e.remove(),tF(!1)}}if("paused"!==V){let e=i;tg(J=tW(O*F.stepWidth-.5*e.width,0,eu()),H)}V="playing",eJ.start(o),A&&l&&l.startStream(n,eJ.getStartTime(),{isAudible:e=>!G||e.id===N}),eO()},eH=()=>{eJ.stop(),t.singingVoices?.stopStream(),V="stopped",X=0,eO(),es()},eO=()=>{let e="playing"===V;w.playBtn.innerHTML=ep(e?"pause":"play"),w.playBtn.classList.toggle("dtm-play--stop",e)},eG=()=>{let e=el().core;w.undoBtn.disabled=!e.canUndo(),w.redoBtn.disabled=!e.canRedo()},eq=()=>{for(let[e,t]of(w.trackTabs.innerHTML="",ee.entries())){let[o,a,r]=t.config.color,n=document.createElement("button");n.className=`dtm-pill ${t.config.id===N?"dtm-pill--active":""}`,n.style.setProperty("--dtm-pill-color",`rgb(${o},${a},${r})`),n.title=t.config.name,n.textContent=String(e+1),n.addEventListener("click",()=>ez(t.config.id)),w.trackTabs.appendChild(n)}let e=el();w.trackBody.innerHTML=`
      <div class="dtm-row">
      ...
      <div class="dtm-row" data-dtm="lyric-body" style="flex-direction:column;align-items:stretch">
        ...
        <div class="dtm-row">
          ...
          <button class="dtm-btn dtm-btn--primary" data-dtm="chord-apply">\u9069\u7528</button>
        </div>`,w.trackBody.appendChild(t);let a=t.querySelector('[data-dtm="chord-pattern"]'),r=t.querySelector('[data-dtm="chord-input"]');a.value=e.savedChordPattern;let n=()=>{e.savedChordInput=r.value,e.savedChordPattern=a.value};a.addEventListener("change",n),r.addEventListener("input",n),t.querySelector('[data-dtm="chord-info"]').addEventListener("click",()=>{o("コード進行の自動入力解説",tO)}),t.querySelector('[data-dtm="chord-apply"]').addEventListener("click",()=>{n(),e0()})}},ez=e=>{N=e,eq(),eG(),es()},eX=e=>{for(let[t,o]of(T=e,[[w.toolPen,"pen"],[w.toolSelect,"select"],[w.toolEraser,"eraser"]]))t.classList.toggle("dtm-segbtn--active",o===e);"select"!==e&&($=null,Z=[]),es()},eW=()=>{let e=Number(w.barLimitSelect.value),t=e>0?e*F.stepsPerBar:1/0,o=e=>t===1/0?e:e.filter(e=>e.startStep<t),a={};ee.forEach((e,t)=>{e.trackInstrument&&(a[t]=e.trackInstrument)});let r=Object.keys(a).length>0?a:void 0,n=tI({instrument:R||void 0,drum:"none"!==L?L:void 0,volume:M,drumVolume:S,mode:Q,trackInstruments:r}," "),l=tI({instrument:R||void 0,drum:"none"!==L?L:void 0,volume:M,drumVolume:S,mode:Q,trackInstruments:r},"");if(w.decomposeChordToggle.checked){let t=w.ignoreChordHeavyToggle.checked?ee.filter(e=>!((e,t=.6)=>{if(e.length<3)return!1;let o=new Map;for(let t of e)o.set(t.startStep,(o.get(t.startStep)??0)+1);return e.filter(e=>(o.get(e.startStep)??0)>=3).length/e.length>=t})(e.core.getNotes())):ee,a=ee.length-t.length,r=(e=>{let t=[...e].sort((e,t)=>e.startStep-t.startStep||e.pitch-t.pitch),o=[],a=[];for(let e of t){let t=-1,r=1/0;for(let n=0;n<o.length;n++)a[n]<=e.startStep&&a[n]<r&&(r=a[n],t=n);-1===t?(o.push([e]),a.push(e.startStep+e.durationSteps)):(o[t].push(e),a[t]=e.startStep+e.durationSteps)}return o})(o(t.flatMap(e=>e.core.getNotes()))),A=ee[0].core,u=r.map((e,t)=>`@${t} ${A.getMMLFromNotes(e,D,100).trim()}`),i=r.map((e,t)=>`@${t}${A.getMMLFromNotes(e,D,100).trim().replace(/\s+/g,"")}`);return{full:[n,...u,ew].filter(e=>e.length>0).join(";\n"),minified:[l,...i,ew].filter(e=>e.length>0).join(";"),ignoredCount:a,trackCount:r.length,barLimit:e}}let A=[],u=[];ee.forEach((e,t)=>{let a=o(e.core.getNotes());if(a.length>0){let o=e.core.getMMLFromNotes(a,D,e.volume).trim();A.push(`@${t} ${o}`),u.push(`@${t}${o.replace(/\s+/g,"")}`)}});let i=ee.map((e,t)=>({i:t,notes:o(e.core.getNotes()),text:e.lyrics.replace(/[\r\n]+/g," ").trim(),model:e.lyricModel.trim(),vol:e.vocalVolume,gate:e.vocalGate,pan:e.vocalPan,oct:e.vocalOctave})).filter(e=>e.model.length>0&&e.text.length>0&&e.notes.length>0).map(e=>{let t=[200===e.vol?"":`v${e.vol}`,100===e.gate?"":`q${e.gate}`,64===e.pan?"":`p${e.pan}`,0===e.oct?"":`o${e.oct}`].filter(e=>e.length>0).join(" "),o=t?`${e.model} ${t}`:e.model;return`@@${e.i} ${o} ${e.text}`});return{full:[n,...A,...i,ew].filter(e=>e.length>0).join(";\n"),minified:[l,...u,...i,ew].filter(e=>e.length>0).join(";"),ignoredCount:0,trackCount:A.length,barLimit:e}},ej=()=>{let e=Number.MAX_SAFE_INTEGER,t=[];for(let o of ee)for(let a of o.core.getNotes())a.startStep<e?(e=a.startStep,t=[a]):a.startStep===e&&t.push(a);return 0===t.length?null:Math.round(t.reduce((e,t)=>e+t.pitch,0)/t.length)},eZ=e=>{let t=i;H=tW((F.keyCount-1-(e-F.pitchRangeStart))*F.keyHeight-(t.height-F.keyHeight)/2,0,ei()),tg(J,H)},e$=()=>{for(let e of ee)e.core.resetHistory(),e.core.clearNotesWithoutHistory();es()},e_=e=>{if(!e)return;for(let e of(eH(),e$(),ee))e.core.setLoadMode(!0);let{placements:o,bpm:a,lyrics:r,meta:n,mergedTrackCount:l}=tv(e,{stepsPerBar:F.stepsPerBar,collectLyrics:!0,clampTrackCount:ee.length});for(let e of(n.instrument&&eB[n.instrument]&&(R=n.instrument,t.onInstrumentChange?.(n.instrument)),n.drum&&v[n.drum]&&(L=n.drum,w.drumSelect.value=n.drum,t.onDrumChange?.(n.drum)),void 0!==n.volume&&(M=n.volume,w.masterVolume.value=String(n.volume),w.masterVolumeLabel.textContent=`${n.volume}%`),void 0!==n.drumVolume&&(S=n.drumVolume,w.drumVolume.value=String(n.drumVolume),w.drumVolumeLabel.textContent=`${n.drumVolume}%`),ee.forEach((e,o)=>{let a=tj(n.trackInstruments?.[o]??"");e.trackInstrument!==a&&(e.trackInstrument=a,t.onTrackInstrumentChange?.(o,a))}),ee))e.lyrics="",e.lyricModel="",e.vocalVolume=200,e.vocalGate=100,e.vocalPan=64,e.vocalOctave=0;for(let e of(r?.forEach(e=>{let t=ee[e.trackId];t&&(t.lyrics=e.syllables.map(e=>e.kana).join(""),t.lyricModel=e.model,t.vocalVolume=e.volume,t.vocalGate=e.gate,t.vocalPan=e.pan,t.vocalOctave=e.octave??0)}),o)){let t=ee[e.trackIndex];t&&t.core.addNote(e.startStep,e.pitch,{noteLengthSteps:e.durationSteps})}for(let e of(a&&e5(a),ee))e.core.setLoadMode(!1),e.core.addHistoryOnce();O=0,J=0;let A=ej();null!==A?eZ(A):eZ(48),es(),eq(),eG(),!I&&l>0?(w.mmlLoadNote.textContent="シンプルモードのため、一部のトラックを合算して読み込みました",w.mmlLoadNote.classList.remove("dtm-hidden")):(w.mmlLoadNote.textContent="",w.mmlLoadNote.classList.add("dtm-hidden"))},e0=()=>{let e=el(),t=ee.find(e=>"chord"===e.config.id);if(!t)return;let o=(e=>{let{chordStr:t,patternType:o,rootShift:a,bpm:r,stepsPerBar:n}=e,l=[];if(!t.trim())return l;let A=[];try{A=((e,t=120)=>{let o=[],a=60/t*4,r=new Set("ABCDEFG_=%N"),n=0,l=null;for(let t of e.replace(/[！-～]/g,e=>String.fromCharCode(e.charCodeAt(0)-65248)).replace(/　/g," ").split("\n").map(e=>e.trim()))if(!(!t.length||/^#/.test(t)))for(let e of t.split(/[|lｌ→]/)){if(!e.length)continue;let t=n++*a,A=[];for(let t=0;t<e.length;t++){let o=e[t],a=e[t-1],n=e.slice(t-2,t);r.has(o)&&"/"!==a&&"on"!==n&&("N."!==n||"C"!==o)&&A.push(t)}if(!A.length)continue;let u=2**Math.ceil(Math.log2(A.length)),i=a/u;for(let[a,r]of A.entries()){let n=e.slice(r,a===A.length-1?e.length:A[a+1]).replace(/\s+/g,""),u=n[0];if("_"===u||"N"===u){l=null;continue}if("="===u){l&&(l.duration+=i);continue}let s=t+a*i;if("%"===u){if(null===l)continue;l={...l,when:s,duration:i}}else{let e=n.slice(0,"#"===n[1]?2:1),t=n.slice(e.length).replace(/[\s・]/g,"");l={key:e,chord:t,when:s,duration:i}}o.push(l)}null!==l&&u>A.length&&(l.duration+=i*(u-A.length))}return o})(t,r)}catch{A=[]}if(A.length>0){let e=60/r*4/n,t={};for(let o of A){let a=Math.floor(o.when/e),r=Math.floor(o.duration/e);t[a]||(t[a]=[]),t[a].push({key:o.key,chord:o.chord,whenStep:a,durationSteps:r})}for(let e of Object.values(t))for(let t of e){let e;try{e=[...q(`${t.key}${t.chord}`).notes]}catch{continue}let r=t.durationSteps;if("block"===o)for(let o of e)l.push({startStep:t.whenStep,pitch:48+o+a,durationSteps:r,velocity:100});else if("arpeggio"===o){let o=Math.floor(r/e.length);e.forEach((e,n)=>{l.push({startStep:t.whenStep+n*o,pitch:48+e+a,durationSteps:r-n*o,velocity:100})})}else if("arpeggio-fast"===o)e.forEach((e,o)=>{l.push({startStep:t.whenStep+6*o,pitch:48+e+a,durationSteps:Math.max(12,r-6*o),velocity:100})});else if("offbeat"===o){let o=Math.floor(n/4),A=Math.floor(o/2);for(let n=0;n<4;n++){let u=t.whenStep+n*o+A;if(u<t.whenStep+r)for(let t of e)l.push({startStep:u,pitch:48+t+a,durationSteps:Math.min(A,12),velocity:100})}}else if("yatsume"===o){let o=Math.floor(n/4),A=e=>Math.max(1,Math.round(e*o/480)),u=[0,360,960,1320],i=A(360);for(let o of u){let n=t.whenStep+A(o);if(n<t.whenStep+r)for(let t of e)l.push({startStep:n,pitch:48+t+a,durationSteps:i,velocity:100})}}else"alternating"===o&&e.forEach((e,o)=>{let r=o*Math.floor(n/4);l.push({startStep:t.whenStep+r,pitch:48+e+a,durationSteps:Math.max(12,Math.floor(n/4)),velocity:100})})}}else t.split(/[\s,]+/).filter(e=>e).forEach((e,t)=>{let o;try{o=[...q(e).notes]}catch{return}if(0===o.length)return;let r=t*n;o.forEach((e,t)=>{let o=3*t;l.push({startStep:r+o,pitch:48+e+a,durationSteps:n-o,velocity:100})})});return l})({chordStr:e.savedChordInput,patternType:e.savedChordPattern,rootShift:e.savedChordRoot,bpm:D,stepsPerBar:F.stepsPerBar});for(let e of(t.core.clearNotesWithoutHistory(),t.core.beginBatch(),o))t.core.addNote(e.startStep,e.pitch,{noteLengthSteps:Math.max(1,e.durationSteps),velocity:e.velocity});t.core.endBatch(),t.core.addHistoryOnce(),es()},e3=async e=>{if(!t.parseMidi)return;let o=await t.parseMidi(e),a=e4(o).filter(e=>e.selected).map(e=>e.index);e1(o,a)},e1=(e,t)=>{for(let e of(eH(),e$(),ee))e.core.setLoadMode(!0);for(let e of ee)e.lyrics="",e.lyricModel="",e.vocalVolume=200,e.vocalGate=100,e.vocalPan=64,e.vocalOctave=0;let{placements:o,bpm:a}=I?((e,t,o)=>{let{tracks:a,division:r}=e,n=e8(e),l=r/48,A=[];return t.forEach((e,t)=>{if(t>=o.length)return;let r=a[e];if(!r)return;let n=o[t],u=[],i=0;for(let e of r)if(i+=e.delta,9!==e.channel){if(e.noteOn&&e.noteOn.velocity>0){let t=e.noteOn.noteNumber,o=e.noteOn.velocity;u.push({pitch:t,velocity:o,start:i,end:null})}else if(e.noteOff||e.noteOn&&0===e.noteOn.velocity){let t=e.noteOff||e.noteOn;if(t){let e=t.noteNumber;for(let t=u.length-1;t>=0;t--)if(u[t].pitch===e&&null===u[t].end){u[t].end=i;break}}}}for(let e of u){if(null===e.end)continue;let t=Math.round(e.start/l),o=Math.max(1,Math.round((e.end-e.start)/l));A.push({trackId:n,startStep:t,pitch:e.pitch,durationSteps:o,velocity:e.velocity})}}),{placements:A,bpm:n}})(e,t,ee.map(e=>e.config.id)):((e,t)=>{let{tracks:o,division:a}=e,r=e8(e),n={};for(let e of t){let t=o[e];if(!t)continue;let a=0;for(let e of t)if(a+=e.delta,9!==e.channel){if(e.noteOn&&e.noteOn.velocity>0){let t=e.noteOn.noteNumber,o=e.noteOn.velocity,r=e.channel??0;n[r]||(n[r]=[]),n[r].push({pitch:t,velocity:o,start:a,end:null})}else if(e.noteOff||e.noteOn&&0===e.noteOn.velocity){let t=e.noteOff||e.noteOn;if(t){let o=t.noteNumber,r=e.channel??0;if(n[r])for(let e=n[r].length-1;e>=0;e--){let t=n[r][e];if(t.pitch===o&&null===t.end){t.end=a;break}}}}}}let l=4*a,A=8*l,u={};for(let[e,t]of Object.entries(n)){let o=Number.parseInt(e,10),a=t.filter(e=>null!==e.end);if(0===a.length){u[o]={avgPitch:60,maxSimultaneous:0,hasSubmelodyPattern:!1};continue}let r=a.reduce((e,t)=>e+t.pitch,0)/a.length,n=0,i=[...a].sort((e,t)=>e.start-t.start);for(let e=0;e<i.length;e++){let t=1;for(let o=e+1;o<i.length;o++)i[o].start<i[e].end&&t++;n=Math.max(n,t)}let s=()=>{if(0===i.length)return!1;let e=[],t=i[0].start,o=i[0].end;for(let a=1;a<i.length;a++)i[a].start-i[a-1].end>=l&&(e.push({start:t,end:o}),t=i[a].start),o=i[a].end;return e.push({start:t,end:o}),e.every(e=>e.end-e.start<A)};u[o]={avgPitch:r,maxSimultaneous:n,hasSubmelodyPattern:s()}}let i=Object.keys(n).map(Number).sort((e,t)=>e-t),s=[...i].sort((e,t)=>u[e].avgPitch-u[t].avgPitch),d=u[s[Math.floor(s.length/4)]]?.avgPitch??60,c=i.filter(e=>u[e].avgPitch<=d&&u[e].maxSimultaneous<=2),g=i.filter(e=>u[e].maxSimultaneous<=1&&!c.includes(e)),m=g.filter(e=>u[e].hasSubmelodyPattern),p=g.filter(e=>!u[e].hasSubmelodyPattern),C=i.filter(e=>!c.includes(e)&&!p.includes(e)&&!m.includes(e)),h={melody:p,submelody:m,bass:c,chord:C},B=[],E=a/48;for(let[e,t]of Object.entries(n)){let o=Number.parseInt(e,10),a=null;for(let[e,t]of Object.entries(h))if(t.includes(o)){a=e;break}if(a)for(let e of t){if(null===e.end)continue;let t=Math.round(e.start/E),o=Math.max(1,Math.round((e.end-e.start)/E));B.push({trackId:a,startStep:t,pitch:e.pitch,durationSteps:o,velocity:e.velocity})}}return{placements:B,bpm:r}})(e,t);for(let e of o){let t=ee.find(t=>t.config.id===e.trackId);t&&t.core.addNote(e.startStep,e.pitch,{noteLengthSteps:e.durationSteps,velocity:e.velocity})}for(let e of(e5(Math.round(a)),ee))e.core.setLoadMode(!1),e.core.addHistoryOnce();O=0,J=0;let r=ej();null!==r?eZ(r):eZ(48),es(),eq(),eG()},e2=()=>(e=>{var t;let{tracks:o,drumPattern:a,drumVolume:r=80,bpm:n,stepsPerBar:l}=e,A=[];if(o.forEach((e,t)=>{if(0===e.notes.length)return;let o=t<9?t:t+1&15,a=[];for(let t of e.notes){let r=Math.round(10*t.startStep),n=Math.round((t.startStep+(t.durationSteps||1))*10),l=Math.round((t.velocity??100)*(e.volume??100)/100);a.push({t:r,m:[144|o,t.pitch,l]}),a.push({t:n,m:[144|o,t.pitch,0]})}a.sort((e,t)=>e.t-t.t),A.push(a)}),a&&a.length>0){let e=Math.max(...o.filter(e=>e.notes.length>0).map(e=>Math.max(...e.notes.map(e=>e.startStep+e.durationSteps))),l),t=[],n=Math.ceil(e/l);for(let o=0;o<n;o++){let n=o*l;for(let o of a){let a=n+o.step;if(a>=e)continue;let l=Math.round((o.velocity??1)*(r/100)*127);t.push({t:Math.round(10*a),m:[153,o.pitch,l]}),t.push({t:Math.round((a+1)*10),m:[153,o.pitch,0]})}}t.sort((e,t)=>e.t-t.t),t.length>0&&A.push(t)}let u=[];for(let e of(t=A.length+1,u.push(77,84,104,100),u.push(...te(6)),u.push(...e9(1)),u.push(...e9(t)),u.push(...e9(480)),to(u,e=>{e.push(0,255,81,3,...e7(Math.round(6e7/n)))}),A))to(u,t=>{let o=0;for(let a of e)t.push(...tt(a.t-o),...a.m),o=a.t});return new Blob([new Uint8Array(u).buffer],{type:"audio/midi"})})({tracks:ee.map(e=>({notes:e.core.getNotes(),volume:e.volume})),drumPattern:v[L],drumVolume:S,bpm:D,stepsPerBar:F.stepsPerBar}),e5=e=>{for(let t of(D=e,w.bpmInput.value=String(e),ee))t.core.setTempo(e)},ta=0,tu=()=>{let e=Date.now();e-ta<100||(ta=e,el().core.undo(),es(),eG())},tm=()=>{el().core.redo(),es(),eG()},th=e=>{w.overlay.hidden=!1,tF(!0),setTimeout(()=>{e(),w.overlay.hidden=!0,tF(!1)},30)},tB=e=>new Promise(t=>{let o=document.createElement("div");o.className="dtm-modal-overlay",o.innerHTML=`
				<div class="dtm-modal">
					<div class="dtm-modal-header">
				...
				</div>`;let a=e=>{o.remove(),t(e)};o.querySelector(".dtm-confirm-yes").addEventListener("click",()=>a(!0)),o.querySelector(".dtm-confirm-no").addEventListener("click",()=>a(!1)),o.addEventListener("click",e=>{e.target===o&&a(!1)}),document.body.appendChild(o)}),tE=null,tf=[],tQ=e=>{if(e.ctrlKey||e.metaKey)if("KeyZ"!==e.code||e.shiftKey){if("KeyZ"===e.code&&e.shiftKey||"KeyY"===e.code)e.preventDefault(),tm();else if("KeyC"===e.code&&Z.length>0)e.preventDefault(),_=[...Z];else if("KeyX"===e.code&&Z.length>0){if(e.preventDefault(),!eb()){_=[...Z];let e=el().core;for(let t of(e.beginBatch(),Z))e.deleteNoteById(t.id);e.endBatch(),Z=[]}}else if("KeyV"===e.code&&_.length>0){if(e.preventDefault(),eb())return;let t=el().core,o=t.getNotes(),a=Math.min(..._.map(e=>e.startStep));for(let e of(t.beginBatch(),_)){let r=O+(e.startStep-a),n=r+e.durationSteps;o.some(t=>t.pitch===e.pitch&&r<t.startStep+t.durationSteps&&n>t.startStep)||t.addNote(r,e.pitch,{noteLengthSteps:e.durationSteps,velocity:e.velocity})}t.endBatch(),es()}}else e.preventDefault(),tu()};eD(),ee=f.map(e=>{let o=[];return{config:e,core:new tp({onMMLGenerated:()=>{},onNotesChanged:a=>{if(W){if(!et&&t.onNotesPatch){let r=new Map(o.map(e=>[`${e.startStep}_${e.pitch}`,e])),n=new Map(a.map(e=>[`${e.startStep}_${e.pitch}`,e])),l=a.filter(e=>{let t=r.get(`${e.startStep}_${e.pitch}`);return!t||t.durationSteps!==e.durationSteps||t.velocity!==e.velocity}).map(e=>({startStep:e.startStep,pitch:e.pitch,durationSteps:e.durationSteps,velocity:e.velocity})),A=o.filter(e=>!n.has(`${e.startStep}_${e.pitch}`)).map(e=>({startStep:e.startStep,pitch:e.pitch}));(l.length>0||A.length>0)&&t.onNotesPatch(e.id,l,A)}o=a.map(e=>({...e})),es(),eG()}}},e.volume),volume:e.volume,savedChordInput:"",savedChordPattern:"block",savedChordRoot:0,lyrics:"",lyricModel:"",vocalVolume:200,vocalGate:100,vocalPan:64,vocalOctave:0,trackInstrument:""}}),W=!0,a=!1,r=!1,w.hScroll.addEventListener("pointerdown",e=>{a=!0,e.preventDefault(),w.hScroll.setPointerCapture(e.pointerId),n(e.clientX)}),w.vScroll.addEventListener("pointerdown",e=>{r=!0,e.preventDefault(),w.vScroll.setPointerCapture(e.pointerId),l(e.clientY)}),w.hScroll.addEventListener("pointermove",e=>{a&&n(e.clientX)}),w.vScroll.addEventListener("pointermove",e=>{r&&l(e.clientY)}),w.hScroll.addEventListener("pointerup",()=>{a=!1}),w.vScroll.addEventListener("pointerup",()=>{r=!1}),document.addEventListener("pointermove",e=>{a&&n(e.clientX),r&&l(e.clientY)}),document.addEventListener("pointerup",()=>{a=!1,r=!1}),n=e=>{let t=eu();if(t<=0)return;let o=w.hScroll.getBoundingClientRect(),a=Number.parseFloat(w.hScrollThumb.style.width)||40,r=tW(e-o.left-a/2,0,o.width-a)/(o.width-a);tg(J=tW(r*t,0,t),H),es()},l=e=>{let t=ei();if(t<=0)return;let o=w.vScroll.getBoundingClientRect(),a=Number.parseFloat(w.vScrollThumb.style.height)||40,r=tW(e-o.top-a/2,0,o.height-a)/(o.height-a);H=tW(r*t,0,t),tg(J,H),es()},w.playBtn.addEventListener("click",()=>{"playing"===V?eH():eK()}),w.playBtn.disabled=!1,w.prevBarBtn.addEventListener("click",()=>{tS(Math.max(0,Math.floor((tM()-1)/F.stepsPerBar)*F.stepsPerBar))}),w.nextBarBtn.addEventListener("click",()=>{tS(Math.floor(tM()/F.stepsPerBar+1)*F.stepsPerBar)}),w.soloCheckbox.addEventListener("change",()=>{G=w.soloCheckbox.checked,es()}),w.toolPen.addEventListener("click",()=>eX("pen")),w.toolSelect.addEventListener("click",()=>eX("select")),w.toolEraser.addEventListener("click",()=>eX("eraser")),w.undoBtn.addEventListener("click",tu),w.redoBtn.addEventListener("click",tm),w.noteLengthSelect.addEventListener("change",()=>{U=P=Number.parseInt(w.noteLengthSelect.value,10),es()}),w.bpmInput.addEventListener("input",()=>{e5(Number.parseInt(w.bpmInput.value,10)||120)}),w.zoomXIn.addEventListener("click",()=>{k=Math.min(200,k+25),eS(),eN()}),w.zoomXOut.addEventListener("click",()=>{k=Math.max(25,k-25),eS(),eN()}),w.zoomYIn.addEventListener("click",()=>{x=Math.min(200,x+25),eL(),eN()}),w.zoomYOut.addEventListener("click",()=>{x=Math.max(50,x-25),eL(),eN()}),w.decomposeChordToggle.addEventListener("change",eN),w.ignoreChordHeavyToggle.addEventListener("change",eN),w.masterVolume.addEventListener("input",()=>{M=Number.parseInt(w.masterVolume.value,10)||0,w.masterVolumeLabel.textContent=`${M}%`}),w.drumSelect.addEventListener("change",()=>{L=w.drumSelect.value,t.onDrumChange?.(L)}),w.drumVolume.addEventListener("input",()=>{S=Number.parseInt(w.drumVolume.value,10)||0,w.drumVolumeLabel.textContent=`${S}%`}),w.macroClear.addEventListener("click",()=>{let e=el();e.core.beginBatch(),e.core.clearNotesWithoutHistory(),e.core.endBatch(),e.core.saveHistory(),es()}),w.macroRandom.addEventListener("click",()=>{((e,t)=>{let{stepsPerBar:o,startStep:a,pitchRangeStart:r}=t,n=r+60,l=e6[Math.floor(Math.random()*e6.length)],A=Math.floor(12*Math.random()),u=[];for(let e=0;e<12;e++){let t=(e-A+12)%12;l.includes(t)&&u.push(n+e)}e.beginBatch();for(let t=0;t<8;t++){let r=a+t*o,n=Math.floor(4*Math.random())+2,l=new Set;for(let t=0;t<n;t++){let t=r+24*Math.floor(o/24*Math.random());if(l.has(t))continue;l.add(t);let a=u[Math.floor(Math.random()*u.length)];e.addNote(t,a,{noteLengthSteps:24})}}e.endBatch(),e.saveHistory()})(el().core,{stepsPerBar:F.stepsPerBar,startStep:O,pitchRangeStart:F.pitchRangeStart}),es()}),w.macroHarmonic.addEventListener("click",()=>{let e=ee.find(e=>"chord"===e.config.id);e&&"chord"!==N&&(((e,t,o)=>{let a=o.stepsPerBar/2,r=e.getNotes().concat(t.getNotes());if(0===r.length)return;let n=Math.ceil(Math.max(...r.map(e=>e.startStep+e.durationSteps))/a),l=new Set;e.beginBatch();for(let o=0;o<n;o++){let r=o*a,n=r+a,A=o%2==0,u=t.getNotes().filter(e=>e.startStep>=r&&e.startStep<n);if(u.length>0?l=new Set(u.map(e=>e.pitch%12)):A&&(l=new Set),0!==l.size)for(let t of e.getNotes().filter(e=>e.startStep>=r&&e.startStep<n))l.has(t.pitch%12)||e.deleteNoteById(t.id)}e.endBatch(),e.saveHistory()})(el().core,e.core,{stepsPerBar:F.stepsPerBar}),es())}),w.macroMono.addEventListener("click",()=>{let e=ee.find(e=>"chord"===e.config.id);e&&"chord"!==N&&(((e,t,o)=>{let a=o.stepsPerBar/2,r=e.getNotes().concat(t.getNotes());if(0===r.length)return;let n=Math.ceil(Math.max(...r.map(e=>e.startStep+e.durationSteps))/a),l=new Set;e.beginBatch();for(let o=0;o<n;o++){let r=o*a,n=r+a,A=o%2==0,u=t.getNotes().filter(e=>e.startStep>=r&&e.startStep<n);if(u.length>0?l=new Set(u.map(e=>e.pitch%12)):A&&(l=new Set),0===l.size)continue;let i=e.getNotes().filter(e=>e.startStep>=r&&e.startStep<n),s=i.filter(e=>l.has(e.pitch%12)),d=new Set(s.map(e=>e.id));for(let t of i)d.has(t.id)||e.deleteNoteById(t.id);let c=new Map;for(let e of s)c.has(e.startStep)||c.set(e.startStep,[]),c.get(e.startStep)?.push(e);for(let t of c.values())if(t.length>1){t.sort((e,t)=>t.pitch-e.pitch);let[,...o]=t;for(let t of o)e.deleteNoteById(t.id)}}e.endBatch(),e.saveHistory()})(el().core,e.core,{stepsPerBar:F.stepsPerBar}),es())}),w.generateMmlBtn.addEventListener("click",()=>{let{full:e,minified:t,ignoredCount:o,trackCount:a,barLimit:r}=eW();w.outputFull.textContent=e,w.outputMini.textContent=t;let n=w.decomposeChordToggle.checked,l=o>0?` / \u4F34\u594F${o}\u30C8\u30E9\u30C3\u30AF\u9664\u5916`:"",A=r>0?` / \u301C${r}\u5C0F\u7BC0`:"";w.outputStatus.textContent=`[${n?"和音分解":"通常"}] (${a}\u30C8\u30E9\u30C3\u30AF${l}${A}) \u901A\u5E38: ${e.length}\u6587\u5B57 / minify: ${t.length}\u6587\u5B57`,w.outputContainer.classList.remove("dtm-hidden"),eG()}),w.exportMidiBtn.addEventListener("click",()=>{let e=e2(),t=URL.createObjectURL(e),o=document.createElement("a");o.href=t,o.download="dtm.mid",o.click(),URL.revokeObjectURL(t)}),m=(e,t)=>{navigator.clipboard?.writeText(e),t.classList.add("dtm-btn--success"),setTimeout(()=>t.classList.remove("dtm-btn--success"),1200)},w.copyFullBtn.addEventListener("click",()=>m(w.outputFull.textContent??"",w.copyFullBtn)),w.copyMiniBtn.addEventListener("click",()=>m(w.outputMini.textContent??"",w.copyMiniBtn)),w.mmlLoadBtn.addEventListener("click",async()=>{let e=w.mmlInput.value;if(!I&&t.onRequestAdvancedMode){let{mergedTrackCount:o}=tv(e,{stepsPerBar:F.stepsPerBar,clampTrackCount:ee.length});if(o>0&&await tB("初心者モードで読み込むと、音が崩れる可能性があります。<br>上級者モードに切り替えますか？"))return void t.onRequestAdvancedMode(e)}th(()=>e_(e))}),p=null,h=null,B=()=>{if(p&&(p.stop(),p.destroy(),p=null),h){h.textContent="▶ 試聴",h.classList.remove("dtm-btn--danger"),h.classList.add("dtm-btn--primary");let e=h.closest(".dtm-modal-sample-box"),t=e?.querySelector(".dtm-modal-sample-player-container");t&&(t.innerHTML=""),h=null}},o=(e,o)=>{for(let t of(B(),w.modalTitle.textContent=e,w.modalBody.innerHTML=o,w.modalOverlay.removeAttribute("hidden"),w.modalBody.querySelectorAll(".dtm-modal-sample-copy-btn")))t.addEventListener("click",()=>{let e=t.getAttribute("data-mml")||"";navigator.clipboard.writeText(e).then(()=>{let e=t.textContent;t.textContent="✓ コピー完了",t.classList.add("dtm-btn--success"),setTimeout(()=>{t.textContent=e,t.classList.remove("dtm-btn--success")},1200)})});for(let e of w.modalBody.querySelectorAll(".dtm-modal-sample-play-btn")){let o=e;o.addEventListener("click",()=>{let e=o.closest(".dtm-modal-sample-box"),a=e?.querySelector(".dtm-modal-sample-player-container"),r=o.getAttribute("data-mml")||"";if(h===o)p?.isPlaying()?p.stop():(eH(),p&&(p.play(),o.textContent="■ 停止",o.classList.remove("dtm-btn--primary"),o.classList.add("dtm-btn--danger")));else if(B(),eH(),h=o,o.textContent="■ 停止",o.classList.remove("dtm-btn--primary"),o.classList.add("dtm-btn--danger"),a){a.innerHTML="";let e=tH(a,r,{onPlayNote:e=>{if(t.onPlayNote){let o=f[Number(e.trackId)],a=o?o.id:e.trackId;t.onPlayNote({...e,trackId:a})}},onPlayDrum:t.onPlayDrum,onResumeAudio:t.onResumeAudio,getAudioTime:t.getAudioTime,singingVoices:t.singingVoices,drumPatterns:t.drumPatterns,volume:M,_skipInfoModals:!0,onStop:()=>{h===o&&(o.textContent="▶ 試聴",o.classList.remove("dtm-btn--danger"),o.classList.add("dtm-btn--primary"))}});p=e,e.play()}})}},w.modalClose.addEventListener("click",()=>{B(),w.modalOverlay.setAttribute("hidden","")}),w.modalOverlay.addEventListener("click",e=>{e.target===w.modalOverlay&&(B(),w.modalOverlay.setAttribute("hidden",""))}),w.mmlInfoBtn.addEventListener("click",()=>{o("MMLの書き方解説",tC)}),w.midiInfoBtn.addEventListener("click",()=>{o("MIDIの読み込み解説",tG)}),w.shiftApplyBtn.addEventListener("click",()=>th(()=>{((e,t)=>{if(0!==t)for(let o of e)for(let e of[...o.getNotes()]){let a=e.startStep+t;a<0?o.deleteNoteById(e.id):o.moveNote(e.id,a,e.pitch)}})(ee.map(e=>e.core),Number.parseInt(w.shiftSelect.value,10)||0),es()})),y&&(w.midiInput.addEventListener("change",async()=>{let e=w.midiInput.files?.[0];if(!e||!t.parseMidi)return;w.overlay.hidden=!1,tF(!0);let o=new Uint8Array(await e.arrayBuffer());tf=e4(tE=await t.parseMidi(o)),w.midiTrackSelection.innerHTML='<span class="dtm-label">トラック</span>',tf.forEach((e,t)=>{let o=document.createElement("button");o.className=`dtm-btn ${e.selected?"dtm-btn--primary":"dtm-btn--ghost"}`,o.dataset.selected=String(e.selected),o.textContent=`${e.name} (${e.noteCount})`,o.addEventListener("click",()=>{let e="true"!==o.dataset.selected;o.dataset.selected=String(e),o.classList.toggle("dtm-btn--primary",e),o.classList.toggle("dtm-btn--ghost",!e)}),w.midiTrackSelection.appendChild(o),0===t&&(w.midiTrackSelection.dataset.ready="1")}),w.midiTrackSelection.classList.remove("dtm-hidden"),w.overlay.hidden=!0,tF(!1)}),w.midiLoadBtn.addEventListener("click",async()=>{if(!tE)return;let e=[];if(w.midiTrackSelection.querySelectorAll("button").forEach((t,o)=>{"true"===t.dataset.selected&&e.push(tf[o].index)}),0!==e.length){if(!I&&t.onRequestAdvancedMode&&e.length>ee.length&&await tB("初心者モードで読み込むと、音が崩れる可能性があります。<br>上級者モードに切り替えますか？")){let o=tE,a=e.slice();t.onRequestAdvancedMode(void 0,e=>{e.applyMidiParsed?.(o,a)});return}th(()=>e1(tE,e))}})),document.addEventListener("keydown",tQ),w.root.addEventListener("keydown",e=>{let t=e.target;"TEXTAREA"!==t.tagName&&"INPUT"!==t.tagName||(e.ctrlKey||e.metaKey)&&["KeyZ","KeyY","KeyV","KeyC","KeyX"].includes(e.code)&&e.stopPropagation()}),e5(D),eq(),eO(),eG(),es(),t.initialMML&&e_(t.initialMML);let ty=null,tw=new ResizeObserver(()=>{ty&&clearTimeout(ty),ty=setTimeout(()=>eD(),150)});tw.observe(w.rollContainer),document.addEventListener("pointermove",ek),document.addEventListener("pointerup",ex);let tF=e=>{j=e,w.topbar.classList.toggle("is-loading",e)},tM=()=>"playing"===V?X:"paused"===V?z:O,tS=async e=>{"playing"===V?(eJ.stop(),t.singingVoices?.stopStream(),O=e,z=e,X=e,V="paused",await eK()):tL(e)},tL=e=>{O=e,z=e,X=e,V="paused";let t=i;tg(J=tW(e*F.stepWidth-.5*t.width,0,eu()),H),eO(),es()};return{play:eK,pause:()=>{"playing"===V&&(z=X,eJ.stop(),t.singingVoices?.stopStream(),V="paused",eO())},stop:eH,getMML:eW,setInstrument:e=>{R=e},getDrum:()=>L,setDrum:e=>{("none"===e||v[e])&&(L=e,w.drumSelect.value=e,t.onDrumChange?.(e))},getViewState:eR,setViewState:e=>{"number"==typeof e.zoomX&&(k=tW(e.zoomX,25,200),eS()),"number"==typeof e.zoomY&&(x=tW(e.zoomY,50,200),eL()),"boolean"==typeof e.decomposeChord&&(w.decomposeChordToggle.checked=e.decomposeChord),"boolean"==typeof e.ignoreChordHeavy&&(w.ignoreChordHeavyToggle.checked=e.ignoreChordHeavy)},loadMML:e_,loadMIDI:e3,applyMidiParsed:(e,t)=>{th(()=>e1(e,t))},exportMIDI:e2,setBpm:e5,getPlaybackState:()=>V,getCurrentPlayStep:tM,forcePauseAt:tL,setLoading:tF,applyPatch:(e,t,o)=>{let a=ee.find(t=>t.config.id===e);if(a){for(let e of(et=!0,a.core.beginBatch(),t)){let t=a.core.getNotes().find(t=>t.startStep===e.startStep&&t.pitch===e.pitch);t&&a.core.deleteNoteById(t.id),a.core.addNote(e.startStep,e.pitch,{noteLengthSteps:e.durationSteps,velocity:e.velocity})}for(let e of o){let t=a.core.getNotes().find(t=>t.startStep===e.startStep&&t.pitch===e.pitch);t&&a.core.deleteNoteById(t.id)}a.core.endBatch(),et=!1,es()}},setTrackVisible:(e,t)=>{t?er.delete(e):er.add(e),es()},setTrackAudible:(e,t)=>{t?en.delete(e):en.add(e)},applyLyrics:(e,t)=>{let o=ee.find(t=>t.config.id===e);o&&(o.lyrics=t.lyrics,o.lyricModel=t.model,o.vocalVolume=t.vocalVolume,o.vocalGate=t.vocalGate,o.vocalPan=t.vocalPan,o.vocalOctave=t.vocalOctave)},applyTrackInstrument:(e,t)=>{let o=ee[e];o&&(o.trackInstrument=tj(t),o.config.id===N&&eq())},noteToCanvas:(e,t)=>{let o=i,a=e*F.stepWidth-J,r=(F.keyCount-1-t)*F.keyHeight-H,n=a>=0&&a<=o.width&&r>=0&&r<=o.height,l=null;return n||(l=a<0?"left":a>o.width?"right":r<0?"top":"bottom"),{x:a,y:r,onScreen:n,side:l}},destroy:()=>{eJ.stop(),t.singingVoices?.stopStream(),tw.disconnect(),document.removeEventListener("pointermove",ek),document.removeEventListener("pointerup",ex),document.removeEventListener("keydown",tQ),e.innerHTML=""}}})(e,O);J.push(G);let Y=p??a.presetUI,V=e.querySelector('[data-dtm="roll"]');Y&&(P.get(e)?.destroy(),K=T(e,{getDaw:()=>G,getTrackIds:()=>v,value:D,loadingTarget:V??e,position:"prepend",onChange:e=>{M=e}}),P.set(e,K)),G.setInstrument(D);let z=V?tx(V):null;return G.setLoading?.(!0),R(D,v,S?"advanced":"simple").finally(()=>{z?.remove(),G.setLoading?.(!1)}),{...G,setInstrument:e=>{G.setInstrument(e),M=e,K&&K.setValue(e)},applyTrackInstrument:(e,t)=>{G.applyTrackInstrument(e,t),H(e,t)},destroy:()=>{G.destroy(),K?.destroy(),P.get(e)===K&&P.delete(e);let t=J.indexOf(G);t>=0&&J.splice(t,1)}}};return{audioContext:r,singingVoices:Q,mountEditor:O,mountPlayer:(e,t,o={})=>{let a=tv(t,{}),l=a.meta??{},A=l.instrument&&eB[l.instrument]?l.instrument:x,u="advanced"===l.mode,i=[...new Set(a.placements.map(e=>e.trackIndex))].map(e=>D(e,u?"advanced":"simple")),s=i.length>0?i:[...oa],d=new Map,c=async()=>{if(l.trackInstruments)for(let[e,t]of(await I,Object.entries(l.trackInstruments))){let o=b(t);o&&(d.set(Number(e),o),await k(o))}};Promise.all([R(A,s,u?"advanced":"simple"),c()]);let g=tH(e,t,{getAudioTime:()=>r.currentTime,onResumeAudio:m,onPlayNote:e=>{let t,o=Number(e.trackId),a=d.get(o);(t=a?w.get(a):L(A,D(o,u?"advanced":"simple"),u?"advanced":"simple"))&&t.play({ctx:r,destination:n,pitch:e.pitch,volume:e.volume,when:e.when,duration:e.duration})},onPlayDrum:U,singingVoices:Q,...o});return K.push(g),{...g,destroy:()=>{g.destroy();let e=K.indexOf(g);e>=0&&K.splice(e,1)}}},loadPreset:R,defaultPreset:x,mountPresetSelect:T,mountModeSwitch:(e,t)=>{let o=e.ownerDocument,a=t.tracksFor??(e=>"advanced"===e?tV:tY),r={simple:t.labels?.simple??"初心者",advanced:t.labels?.advanced??"上級者"},n=e=>"function"==typeof t.editorOptions?t.editorOptions(e):t.editorOptions??{},l=t.mode??"simple",A=null,u=o.createElement("div");if(u.className=t.className??"dtm-controlbar",null!==t.label){let e=o.createElement("span");e.className="dtm-controlbar-label",e.textContent=t.label??"モード",u.appendChild(e)}let i=o.createElement("div");i.className="dtm-modeseg";let s=new Map,d=()=>{for(let[e,t]of s)t.classList.toggle("dtm-modebtn--active",e===l)};for(let e of["simple","advanced"]){let t=o.createElement("button");t.type="button",t.className="dtm-modebtn",t.textContent=r[e],t.addEventListener("click",()=>m(e)),i.appendChild(t),s.set(e,t)}u.appendChild(i);let c=(o,r)=>{let i=n(o);A=O(t.editorTarget,{...i,mode:o,tracks:a(o),initialMML:r??i.initialMML,onRequestAdvancedMode:(e,o)=>{g(),l="advanced",d(),t.onChange?.("advanced"),c("advanced",e),o&&A&&o(A)}}),"prepend"===t.position?e.insertBefore(u,e.firstChild):e.appendChild(u),t.onMount?.(A,o)},g=()=>{if(!A)return;let e=A.getMML().full;return t.onUnmount?.(A,l),A.destroy(),A=null,e};function m(e){if(e===l&&A)return;let o=g();l=e,d(),t.onChange?.(e),c(e,o)}d(),c(l,n(l).initialMML);let p={element:u,getDaw:()=>A,getMode:()=>l,setMode:m,destroy:()=>{g(),u.remove();let e=H.indexOf(p);e>=0&&H.splice(e,1)}};return H.push(p),p},dispose:()=>{for(let e of[...H])e.destroy();for(let e of K)e.destroy();for(let e of J)e.destroy();H.length=0,K.length=0,J.length=0,r.close()}}};let on=Function("url","return import(url)");async function ol(e,t){let o=await on(e);return o[t]??o.default}let oA=null;e.s(["getStudio",0,()=>(oA||(oA=(async()=>{let[e,t,o]=await Promise.all([ol("https://rpgen3.github.io/soundfont/mjs/surikov/SoundFont.mjs","SoundFont"),ol("https://rpgen3.github.io/soundfont/mjs/surikov/SoundFont_drum.mjs","SoundFont_drum"),ol("https://rpgen3.github.io/soundfont/mjs/surikov/SoundFont_list.mjs","SoundFont_list")]);return or({engines:{SoundFont:e,SoundFont_drum:t,SoundFont_list:o}})})()),oA)],48605)}]);