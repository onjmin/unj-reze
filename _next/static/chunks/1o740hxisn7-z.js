...
<div class="dtm-daw" data-dtm="root">
  ...
  <div class="dtm-modal-overlay" data-dtm="modal-overlay" hidden>
    <div class="dtm-win dtm-modal">
...
</div>`;let l=t.querySelector('[data-dtm="root"]'),u=t=>{let e;return e=`[data-dtm="${t}"]`,l.querySelector(e)};return{root:l,topbar:u("transport"),topbarLoading:u("topbar-loading"),playBtn:u("play"),prevBarBtn:u("prev-bar"),nextBarBtn:u("next-bar"),soloCheckbox:u("solo"),toolPen:u("tool-pen"),toolSelect:u("tool-select"),toolEraser:u("tool-eraser"),undoBtn:u("undo"),redoBtn:u("redo"),noteLengthSelect:u("note-length"),bpmInput:u("bpm"),zoomXLabel:u("zoomx-label"),zoomYLabel:u("zoomy-label"),zoomXIn:u("zoomx-in"),zoomXOut:u("zoomx-out"),zoomYIn:u("zoomy-in"),zoomYOut:u("zoomy-out"),rollContainer:u("roll"),wrapper:u("wrapper"),vScroll:u("vscroll"),vScrollThumb:u("vscroll-thumb"),hScroll:u("hscroll"),hScrollThumb:u("hscroll-thumb"),masterVolume:u("master-volume"),masterVolumeLabel:u("master-volume-label"),trackTabs:u("track-tabs"),trackBody:u("track-body"),drumSelect:u("drum-select"),drumVolume:u("drum-volume"),drumVolumeLabel:u("drum-volume-label"),midiInput:u("midi-input"),midiLoadBtn:u("midi-load"),midiInfoBtn:u("midi-info"),midiTrackSelection:u("midi-track-selection"),midiPanel:u("midi-panel"),mmlInput:u("mml-input"),mmlLoadBtn:u("mml-load"),mmlLoadNote:u("mml-load-note"),shiftSelect:u("shift-select"),shiftApplyBtn:u("shift-apply"),macroClear:u("macro-clear"),macroRandom:u("macro-random"),macroHarmonic:u("macro-harmonic"),macroMono:u("macro-mono"),exportMidiBtn:u("export-midi"),generateMmlBtn:u("generate-mml"),decomposeChordToggle:u("decompose-chord"),ignoreChordHeavyToggle:u("ignore-chord-heavy"),barLimitSelect:u("bar-limit"),outputContainer:u("output-container"),outputStatus:u("output-status"),outputFull:u("output-full"),outputMini:u("output-mini"),copyFullBtn:u("copy-full"),copyMiniBtn:u("copy-mini"),overlay:u("overlay"),mmlInfoBtn:u("mml-info"),modalOverlay:u("modal-overlay"),modalTitle:u("modal-title"),modalBody:u("modal-body"),modalClose:u("modal-close")}})(t,{tracks:E,drumPatternNames:Object.keys(I),defaultDrumPattern:I.dance?"dance":Object.keys(I)[0]??"none",defaultBpm:e.defaultBpm??120,showMidi:v,showChord:y}),w={stepsPerBar:192,keyCount:128,pitchRangeStart:0,keyHeight:15,stepWidth:1},F=16*w.stepsPerBar,x=100,k=100,D=e.defaultBpm??120,M=50,S=80,L=b.drumSelect.value,R="",N=E[0].id,T="pen",U=48,J=12,P=0,K=43*w.keyHeight-215,Y=0,H=!1,O=new Set,G="stopped",q=0,z=0,X=!1,W=[],j=null,Z=[],$=[],_=()=>$.find(t=>t.config.id===N)??$[0],tt=()=>{let t=4*w.stepsPerBar;for(let e of $)for(let o of e.core.getNotes()){let e=o.startStep+o.durationSteps;e>t&&(t=e)}return t},te=()=>Math.max(0,w.keyCount*w.keyHeight-d.height),to=()=>{for(let t of(((t=1)=>{eu(),ei(),m.clearRect(0,0,d.width,d.height);let{keyHeight:e,keyCount:o,stepWidth:a,stepsPerBar:r}=p,A=Math.floor(er/e)*e,n=er+d.height;for(let t=A;t<n;t+=e){let a=(o-1-t/e)%12,r=en.has(a),A=0===a,n=t-er;r&&(m.fillStyle="#0d1020",m.fillRect(0,n,d.width,e)),m.beginPath(),m.strokeStyle=A?"#3d405b":"#1a1d30",m.lineWidth=1;let l=n+e;m.moveTo(0,l),m.lineTo(d.width,l),m.stroke()}let l=t||48,u=Math.floor(ea/(a*l))*a*l,i=ea+d.width,s=a*l;for(let t=u;t<=i;t+=s){let e=t/a,o=e%r==0,A=e%l==0,n=t-ea;m.beginPath(),m.strokeStyle=o?"#3d405b":A?"#242840":"#1a1d30",m.lineWidth=o?2:1,m.moveTo(n,0),m.lineTo(n,d.height),m.stroke()}})(48),$)){let[e,o,a]=t.config.color,r=t.config.id===N?1:.3;es(t.core.getNotes(),[e,o,a,r])}if("select"===T&&j){let t=m;t.save(),t.strokeStyle="#ffec27",t.lineWidth=2,t.setLineDash([4,4]),t.strokeRect(j.x,j.y,j.width,j.height),t.fillStyle="rgba(255,236,39,0.08)",t.fillRect(j.x,j.y,j.width,j.height),t.restore()}if("select"===T&&W.length>0){let t=new Set(W.map(t=>t.id)),e=_();((t,e,o=[59,130,246,1])=>{let{keyHeight:a,stepWidth:r,keyCount:A,pitchRangeStart:n}=p;for(let l of t){if(!e.has(l.id))continue;let t=l.startStep*r,u=(A-1-(l.pitch-n))*a,i=l.durationSteps*r,s=t-ea,d=u-er,c=void 0!==l.velocity?.5+l.velocity/127*.5:1,[g,p,C,B]=o,h=Math.min(255,1.3*g),E=Math.min(255,1.3*p),f=Math.min(255,1.3*C),Q=B*c;m.fillStyle=`rgba(${h},${E},${f},${Q})`,m.fillRect(s+1,d+1,i-2,a-2)}})(e.core.getNotes(),t,[...e.config.color,1])}(()=>{let t=m,e=d;if(!t)return;let o=Y*w.stepWidth-P;o<-10||o>e.width+10||(t.save(),t.strokeStyle="#ffec27",t.lineWidth=2,t.setLineDash([4,4]),t.beginPath(),t.moveTo(o,0),t.lineTo(o,e.height),t.stroke(),t.restore())})(),"playing"===G&&(()=>{let t=m,e=d;if(!t)return;let o=z*w.stepWidth-P;o<0||o>e.width||(t.save(),t.strokeStyle="#ff004d",t.lineWidth=2,t.beginPath(),t.moveTo(o,0),t.lineTo(o,e.height),t.stroke(),t.restore())})(),ta()},ta=()=>{let t=d,e=tt(),o=F*w.stepWidth,a=e*w.stepWidth,r=a-t.width+o,A=b.hScroll.clientWidth;if(r<=0)b.hScrollThumb.style.width="100%",b.hScrollThumb.style.left="0";else{let e=Math.max(40,t.width/(a+o)*A),n=P/r;b.hScrollThumb.style.width=`${e}px`,b.hScrollThumb.style.left=`${ez(n*(A-e),0,A-e)}px`}let n=w.keyCount*w.keyHeight,l=b.vScroll.clientHeight;if(n<=t.height)b.vScrollThumb.style.height="100%",b.vScrollThumb.style.top="0";else{let e=Math.max(40,t.height/n*l),o=te(),a=K/o;b.vScrollThumb.style.height=`${e}px`,b.vScrollThumb.style.top=`${a*(l-e)}px`}},tr=!1,tA=!1,tn=null,tl=!1,tu="rect",ti=null,ts=[],td=null,tc=t=>{e.onResumeAudio?.();let o=_();tw(o.config.id,t,o.volume,100,0,.1)},tg=(t,e,o=0)=>{let a=_(),{stepWidth:r,keyHeight:A,keyCount:n,pitchRangeStart:l}=w,u=eA();for(let i of a.core.getNotes()){let a=i.startStep*r,s=(n-1-(i.pitch-l))*A,d=i.durationSteps*r,c=a-u.x,g=s-u.y;if(t>=c-o&&t<=c+d+o&&e>=g-o&&e<=g+A+o)return i}return null},tp=t=>{t.preventDefault(),e.onResumeAudio?.();let{x:o,y:a,step:r,pitch:A}=ed(t),n=_();if("eraser"===T){let t=tg(o,a);t&&n.core.deleteNoteById(t.id);return}if("select"===T){if(W.length>0){let t=tg(o,a);if(t&&W.some(e=>e.id===t.id)){ts=W.map(t=>({id:t.id,startStep:t.startStep,pitch:t.pitch})),tl=!0,tu="move",ti={x:o,y:a,step:r,pitch:A},tA=!1,td=null;return}W=[],j=null}let t=tg(o,a);t?(W=[t],ts=[{id:t.id,startStep:t.startStep,pitch:t.pitch}],tl=!0,tu="move"):(W=[],j=null,tl=!0,tu="rect"),ti={x:o,y:a,step:r,pitch:A},tA=!1;return}tA=!1;let l=tg(o,a,6);if(l){tc(l.pitch);let{stepWidth:t}=w,e=eA(),a=l.startStep*t-e.x,n=l.durationSteps*t;tn=o>=a+n-10&&o<=a+n?{noteId:l.id,mode:"resize",dragOffsetStep:0,dragOffsetPitch:0,startStep:l.startStep,durationSteps:l.durationSteps,lastPreviewPitch:l.pitch}:{noteId:l.id,mode:"move",dragOffsetStep:r-l.startStep,dragOffsetPitch:A-l.pitch,startStep:l.startStep,durationSteps:l.durationSteps,lastPreviewPitch:l.pitch},tr=!0;return}let u=Math.floor(r/U)*U,i=u+U;if(!n.core.getNotes().some(t=>t.pitch===A&&u<t.startStep+t.durationSteps&&i>t.startStep)){n.core.addNote(u,A,{noteLengthSteps:U}),tc(A);let t=n.core.getNotes().find(t=>t.startStep===u&&t.pitch===A);t&&(tn={noteId:t.id,mode:"move",dragOffsetStep:0,dragOffsetPitch:0,startStep:t.startStep,durationSteps:t.durationSteps,lastPreviewPitch:t.pitch},tA=!0),tr=!0}},th=t=>{let e=_();if("pen"===T){if(!tn)return;let{step:a,pitch:r}=ed(t);if(tA=!0,"move"===tn.mode){var o;let t=Math.round((a-tn.dragOffsetStep)/J)*J,A=r-tn.dragOffsetPitch;if(o=tn.noteId,_().core.getNotes().some(e=>e.id!==o&&e.pitch===A&&t>=e.startStep&&t<e.startStep+e.durationSteps))return;e.core.moveNote(tn.noteId,t,A),A!==tn.lastPreviewPitch&&(tn.lastPreviewPitch=A,tc(A));return}let A=Math.max(Math.round((a-tn.startStep+1)/J)*J,J);e.core.resizeNote(tn.noteId,A),tn.durationSteps=A,U=A,to();return}if("select"===T&&tl&&ti){let{x:o,y:a,step:r,pitch:A}=ed(t);if("rect"===tu){let t={x:Math.min(o,ti.x),y:Math.min(a,ti.y),width:Math.abs(o-ti.x),height:Math.abs(a-ti.y)};j=t;let{stepWidth:r,keyHeight:A,keyCount:n,pitchRangeStart:l}=w,u=eA();W=e.core.getNotes().filter(e=>{let o=e.startStep*r,a=n-1-(e.pitch-l),i=o-u.x,s=a*A-u.y,d=e.durationSteps*r;return t.x<i+d&&t.x+t.width>i&&t.y<s+A&&t.y+t.height>s}),to()}else{let t=Math.round((r-ti.step)/J)*J,o=A-ti.pitch;if(0!==t||0!==o){for(let a of(tA=!0,e.core.isBatchOperation||e.core.beginBatch(),W)){let r=ts.find(t=>t.id===a.id);if(!r)continue;let A=r.pitch+o;A>=0&&A<128&&e.core.moveNote(a.id,r.startStep+t,A)}if(W.length>0){let t=W[0],e=ts.find(e=>e.id===t.id);if(e){let t=e.pitch+o;t!==td&&t>=0&&t<128&&(td=t,tc(t))}}}to()}}},tE=()=>{if("pen"===T&&tn){if(tA){let t=_();"move"===tn.mode?t.core.moveNoteEnd(tn.noteId):t.core.resizeNoteEnd(tn.noteId),tr=!0}tn=null,tA=!1}"select"===T&&tl&&(tA&&"move"===tu&&W.length>0&&_().core.endBatch(),tl=!1,ti=null,tA=!1,td=null,j=null,ts=[],to())},tf=()=>{let t=b.rollContainer.clientWidth||800,e=b.rollContainer.clientHeight||450;((t,e=800,o=450,a)=>{p=a;let r=document.createElement("canvas");i=r,r.width=e-60,r.height=20,r.style.position="absolute",r.style.left="60px",r.style.top="0px";let A=r.getContext("2d");if(!A)throw Error("Failed to get 2D rendering context for header.");c=A;let n=document.createElement("canvas");s=n,n.width=60,n.height=o-20,n.style.position="absolute",n.style.left="0px",n.style.top="20px";let l=n.getContext("2d");if(!l)throw Error("Failed to get 2D rendering context for keyboard.");g=l;let u=document.createElement("canvas");d=u,u.width=e-60,u.height=o-20,u.style.position="absolute",u.style.left="60px",u.style.top="20px",u.style.touchAction="none";let C=u.getContext("2d",{willReadFrequently:!0});if(!C)throw Error("Failed to get 2D rendering context for grid.");m=C,t.innerHTML="",t.style.position="relative",t.style.width=`${e+60}px`,t.style.height=`${o}px`,t.append(r,n,u),(()=>{let t=s.parentElement;if(!t)return;let e=t.querySelector("#header-corner");e||((e=document.createElement("div")).id="header-corner",e.style.position="absolute",e.style.left="0px",e.style.top="0px",e.style.width="60px",e.style.height="20px",e.style.backgroundColor="#0a0f1f",e.style.borderRight="2px solid #29adff",e.style.borderBottom="2px solid #29adff",t.insertBefore(e,i))})()})(b.wrapper,t,e,w);let o=d;o.addEventListener("pointerdown",tp),o.addEventListener("dblclick",t=>{t.preventDefault();let{step:e,pitch:o}=ed(t),a=_(),r=a.core.getNotes().find(t=>t.pitch===o&&e>=t.startStep&&e<t.startStep+t.durationSteps);r&&a.core.deleteNoteById(r.id)}),o.addEventListener("wheel",t=>{t.preventDefault(),K=ez(K+t.deltaY,0,te()),ec(P=Math.max(0,P+t.deltaX),K),to()},{passive:!1}),o.addEventListener("click",()=>{tr&&(tr=!1)});let a=i;a.addEventListener("click",t=>{if("playing"===G)return;let e=a.getBoundingClientRect();Y=Math.max(0,Math.floor(Math.floor((t.clientX-e.left+P)/w.stepWidth)/J)*J),"paused"===G&&(G="stopped",tM()),to()}),ec(P,K),to()},tQ=()=>{let t=d,e=(P+t.width/2)/w.stepWidth;w.stepWidth=2*x*.5/100,b.zoomXLabel.textContent=`${x}%`,ec(P=Math.max(0,e*w.stepWidth-t.width/2),K),to()},tI=()=>{let t=d,e=(K+t.height/2)/w.keyHeight;w.keyHeight=15*k/100,b.zoomYLabel.textContent=`${k}%`,K=ez(e*w.keyHeight-t.height/2,0,te()),ec(P,K),to()},tv=()=>({zoomX:x,zoomY:k,decomposeChord:b.decomposeChordToggle.checked,ignoreChordHeavy:b.ignoreChordHeavyToggle.checked}),ty=()=>e.onViewStateChange?.(tv()),tw=(t,o,a,r,A,n)=>{let l=a/100*(r/127)*(M/100);e.onPlayNote?.({trackId:t,pitch:o,velocity:r,volume:l,when:A,duration:n})},tF=ey({getTracks:()=>$.map(t=>({id:t.config.id,volume:t.volume,notes:t.core.getNotes()})),getBpm:()=>D,getPlayStartStep:()=>Y,getDrumPattern:()=>I[L]??null,getSoloTrackId:()=>H?N:null,getAudioTime:h,onPlayNote:t=>{let o=$.findIndex(e=>e.config.id===t.trackId);o>=0&&O.has(o)&&e.singingVoices||e.onPlayNote?.({...t,volume:t.volume*(M/100)})},onPlayDrum:t=>{let o=t.velocity*(S/100)*(M/100);e.onPlayDrum?.({...t,velocity:o})},onTick:t=>{z=t;let e=d.width/w.stepWidth,o=P/w.stepWidth+e-4;if(z>o){let t=Math.round(e/w.stepsPerBar);ec(P+=t*w.stepsPerBar*w.stepWidth,K)}to()},onEnd:t=>{t?(G="paused",q=z):(G="stopped",z=0),tM(),to()},stepsPerBar:w.stepsPerBar}),tx=async()=>{let t;if("playing"===G)return;await e.onResumeAudio?.();let o="paused"===G?q:Y;e.singingVoices?.reset();let a=(t=new Map,$.forEach((e,o)=>{let a=e.lyricModel.trim(),r=e.lyrics.trim();if(!a||!r)return;let A=tD(r);0!==A.length&&t.set(o,{trackId:o,model:a.toLowerCase(),volume:e.vocalVolume,gate:e.vocalGate,pan:e.vocalPan,octave:e.vocalOctave,syllables:A})}),t);O=new Set(a.keys());let r=60/D/48,A=e.singingVoices?[...a.values()].map(t=>{let e=$[t.trackId],a=[...e?.core.getNotes()??[]].sort((t,e)=>t.startStep-e.startStep),A=(t.gate??100)/100,n=(t.octave??0)*12,l=Math.min(a.length,t.syllables.length),u=[];for(let e=0;e<l;e++){let l=a[e];l.startStep<o||u.push({syllable:t.syllables[e],pitch:l.pitch+n,startSec:(l.startStep-o)*r,durationSec:l.durationSteps*r*A})}return{id:e?.config.id,model:t.model,volume:tT(t.volume??200)*(M/100),pan:tU(t.pan??64),notes:u}}):[],n=e.singingVoices,l=!!n&&A.some(t=>t.notes.length>0);if(l&&n){let t=ex(b.rollContainer);el(!0);try{await n.loadModels(A.map(t=>t.model)),await n.warm(A)}catch(t){console.warn("[dtm] voice preload failed",t)}finally{t.remove(),el(!1)}}if("paused"!==G){let t=d;ec(P=Math.max(0,Y*w.stepWidth-.5*t.width),K)}G="playing",tF.start(o),l&&n&&n.startStream(A,tF.getStartTime(),{isAudible:t=>!H||t.id===N}),tM()},tk=()=>{tF.stop(),e.singingVoices?.stopStream(),G="stopped",z=0,tM(),to()},tM=()=>{let t="playing"===G,e=t?"停止":"paused"===G?"再開":"試聴";b.playBtn.innerHTML=`${tm(t?"pause":"play")}<span>${e}</span>`,b.playBtn.classList.toggle("dtm-play--stop",t)},tS=()=>{let t=_().core;b.undoBtn.disabled=!t.canUndo(),b.redoBtn.disabled=!t.canRedo()},tL=()=>{for(let t of(b.trackTabs.innerHTML="",$)){let[e,o,a]=t.config.color,r=document.createElement("button");r.className=`dtm-pill ${t.config.id===N?"dtm-pill--active":""}`,r.style.setProperty("--dtm-pill-color",`rgb(${e},${o},${a})`),r.innerHTML=`<span class="dtm-dot"></span><span>${t.config.name}</span>`,r.addEventListener("click",()=>tR(t.config.id)),b.trackTabs.appendChild(r)}let t=_();b.trackBody.innerHTML=`
      <div class="dtm-row">
      ...
      </div>`;let e=b.trackBody.querySelector('[data-dtm="track-vol"]'),a=b.trackBody.querySelector('[data-dtm="track-vol-label"]');if(e.addEventListener("input",()=>{t.volume=Number.parseInt(e.value,10),t.core.setVolume(t.volume),a.textContent=String(t.volume)}),Q||"chord"!==t.config.id){let e=document.createElement("div");e.className="dtm-row",e.style.flexDirection="column",e.style.alignItems="stretch",e.innerHTML=`
      <div class="dtm-row">
      ...
      <div class="dtm-row" data-dtm="lyric-body" style="flex-direction:column;align-items:stretch">
        ...
        </div>`,b.trackBody.appendChild(e);let a=e.querySelector('[data-dtm="chord-pattern"]'),r=e.querySelector('[data-dtm="chord-input"]');a.value=t.savedChordPattern;let A=()=>{t.savedChordInput=r.value,t.savedChordPattern=a.value};a.addEventListener("change",A),r.addEventListener("input",A),e.querySelector('[data-dtm="chord-info"]').addEventListener("click",()=>{o("コード進行の自動入力解説",eK)}),e.querySelector('[data-dtm="chord-apply"]').addEventListener("click",()=>{A(),tV()})}},tR=t=>{N=t,tL(),tS(),to()},tN=t=>{for(let[e,o]of(T=t,[[b.toolPen,"pen"],[b.toolSelect,"select"],[b.toolEraser,"eraser"]]))e.classList.toggle("dtm-segbtn--active",o===t);"select"!==t&&(j=null,W=[]),to()},tJ=()=>{let t=Number(b.barLimitSelect.value),e=t>0?t*w.stepsPerBar:1/0,o=t=>e===1/0?t:t.filter(t=>t.startStep<e),a=ef({instrument:R||void 0,drum:"none"!==L?L:void 0,volume:M,drumVolume:S,mode:f}," "),r=ef({instrument:R||void 0,drum:"none"!==L?L:void 0,volume:M,drumVolume:S,mode:f},"");if(b.decomposeChordToggle.checked){let e=b.ignoreChordHeavyToggle.checked?$.filter(t=>!((t,e=.6)=>{if(t.length<3)return!1;let o=new Map;for(let e of t)o.set(e.startStep,(o.get(e.startStep)??0)+1);return t.filter(t=>(o.get(t.startStep)??0)>=3).length/t.length>=e})(t.core.getNotes())):$,A=$.length-e.length,n=(t=>{let e=[...t].sort((t,e)=>t.startStep-e.startStep||t.pitch-e.pitch),o=[],a=[];for(let t of e){let e=-1,r=1/0;for(let A=0;A<o.length;A++)a[A]<=t.startStep&&a[A]<r&&(r=a[A],e=A);-1===e?(o.push([t]),a.push(t.startStep+t.durationSteps)):(o[e].push(t),a[e]=t.startStep+t.durationSteps)}return o})(o(e.flatMap(t=>t.core.getNotes()))),l=$[0].core,u=n.map((t,e)=>`@${e} ${l.getMMLFromNotes(t,D,100).trim()}`),i=n.map((t,e)=>`@${e}${l.getMMLFromNotes(t,D,100).trim().replace(/\s+/g,"")}`);return{full:[a,...u,tb].filter(t=>t.length>0).join(";\n"),minified:[r,...i,tb].filter(t=>t.length>0).join(";"),ignoredCount:A,trackCount:n.length,barLimit:t}}let A=[],n=[];$.forEach((t,e)=>{let a=o(t.core.getNotes());if(a.length>0){let o=t.core.getMMLFromNotes(a,D,t.volume).trim();A.push(`@${e} ${o}`),n.push(`@${e}${o.replace(/\s+/g,"")}`)}});let l=$.map((t,e)=>({i:e,notes:o(t.core.getNotes()),text:t.lyrics.replace(/[\r\n]+/g," ").trim(),model:t.lyricModel.trim(),vol:t.vocalVolume,gate:t.vocalGate,pan:t.vocalPan,oct:t.vocalOctave})).filter(t=>t.model.length>0&&t.text.length>0&&t.notes.length>0).map(t=>{let e=[200===t.vol?"":`v${t.vol}`,100===t.gate?"":`q${t.gate}`,64===t.pan?"":`p${t.pan}`,0===t.oct?"":`o${t.oct}`].filter(t=>t.length>0).join(" "),o=e?`${t.model} ${e}`:t.model;return`@@${t.i} ${o} ${t.text}`});return{full:[a,...A,...l,tb].filter(t=>t.length>0).join(";\n"),minified:[r,...n,...l,tb].filter(t=>t.length>0).join(";"),ignoredCount:0,trackCount:A.length,barLimit:t}},tP=()=>{let t=Number.MAX_SAFE_INTEGER,e=[];for(let o of $)for(let a of o.core.getNotes())a.startStep<t?(t=a.startStep,e=[a]):a.startStep===t&&e.push(a);return 0===e.length?null:Math.round(e.reduce((t,e)=>t+e.pitch,0)/e.length)},tK=t=>{let e=d;K=ez((w.keyCount-1-(t-w.pitchRangeStart))*w.keyHeight-(e.height-w.keyHeight)/2,0,te()),ec(P,K)},tY=()=>{for(let t of $)t.core.resetHistory(),t.core.clearNotesWithoutHistory();to()},tH=t=>{if(!t)return;for(let t of(tk(),tY(),$))t.core.setLoadMode(!0);let{placements:o,bpm:a,lyrics:r,meta:A,mergedTrackCount:n}=eQ(t,{stepsPerBar:w.stepsPerBar,collectLyrics:!0,clampTrackCount:$.length});for(let t of(A.instrument&&tB[A.instrument]&&(R=A.instrument,e.onInstrumentChange?.(A.instrument)),A.drum&&I[A.drum]&&(L=A.drum,b.drumSelect.value=A.drum,e.onDrumChange?.(A.drum)),void 0!==A.volume&&(M=A.volume,b.masterVolume.value=String(A.volume),b.masterVolumeLabel.textContent=`${A.volume}%`),void 0!==A.drumVolume&&(S=A.drumVolume,b.drumVolume.value=String(A.drumVolume),b.drumVolumeLabel.textContent=`${A.drumVolume}%`),$))t.lyrics="",t.lyricModel="",t.vocalVolume=200,t.vocalGate=100,t.vocalPan=64,t.vocalOctave=0;for(let t of(r?.forEach(t=>{let e=$[t.trackId];e&&(e.lyrics=t.syllables.map(t=>t.kana).join(""),e.lyricModel=t.model,e.vocalVolume=t.volume,e.vocalGate=t.gate,e.vocalPan=t.pan,e.vocalOctave=t.octave??0)}),o)){let e=$[t.trackIndex];e&&e.core.addNote(t.startStep,t.pitch,{noteLengthSteps:t.durationSteps})}for(let t of(a&&tW(a),$))t.core.setLoadMode(!1),t.core.addHistoryOnce();Y=0,P=0;let l=tP();null!==l?tK(l):ec(P,K),to(),tL(),tS(),!Q&&n>0?(b.mmlLoadNote.textContent="シンプルモードのため、一部のトラックを合算して読み込みました",b.mmlLoadNote.classList.remove("dtm-hidden")):(b.mmlLoadNote.textContent="",b.mmlLoadNote.classList.add("dtm-hidden"))},tV=()=>{let t=_(),e=$.find(t=>"chord"===t.config.id);if(!e)return;let o=(t=>{let{chordStr:e,patternType:o,rootShift:a,bpm:r,stepsPerBar:A}=t,n=[];if(!e.trim())return n;let l=[];try{l=((t,e=120)=>{let o=[],a=60/e*4,r=new Set("ABCDEFG_=%N"),A=0,n=null;for(let e of t.replace(/[！-～]/g,t=>String.fromCharCode(t.charCodeAt(0)-65248)).replace(/　/g," ").split("\n").map(t=>t.trim()))if(!(!e.length||/^#/.test(e)))for(let t of e.split(/[|lｌ→]/)){if(!t.length)continue;let e=A++*a,l=[];for(let e=0;e<t.length;e++){let o=t[e],a=t[e-1],A=t.slice(e-2,e);r.has(o)&&"/"!==a&&"on"!==A&&("N."!==A||"C"!==o)&&l.push(e)}if(!l.length)continue;let u=2**Math.ceil(Math.log2(l.length)),i=a/u;for(let[a,r]of l.entries()){let A=t.slice(r,a===l.length-1?t.length:l[a+1]).replace(/\s+/g,""),u=A[0];if("_"===u||"N"===u){n=null;continue}if("="===u){n&&(n.duration+=i);continue}let s=e+a*i;if("%"===u){if(null===n)continue;n={...n,when:s,duration:i}}else{let t=A.slice(0,"#"===A[1]?2:1),e=A.slice(t.length).replace(/[\s・]/g,"");n={key:t,chord:e,when:s,duration:i}}o.push(n)}null!==n&&u>l.length&&(n.duration+=i*(u-l.length))}return o})(e,r)}catch{l=[]}if(l.length>0){let t=60/r*4/A,e={};for(let o of l){let a=Math.floor(o.when/t),r=Math.floor(o.duration/t);e[a]||(e[a]=[]),e[a].push({key:o.key,chord:o.chord,whenStep:a,durationSteps:r})}for(let t of Object.values(e))for(let e of t){let t;try{t=[...V(`${e.key}${e.chord}`).notes]}catch{continue}let r=e.durationSteps;if("block"===o)for(let o of t)n.push({startStep:e.whenStep,pitch:48+o+a,durationSteps:r,velocity:100});else if("arpeggio"===o){let o=Math.floor(r/t.length);t.forEach((t,A)=>{n.push({startStep:e.whenStep+A*o,pitch:48+t+a,durationSteps:r-A*o,velocity:100})})}else if("arpeggio-fast"===o)t.forEach((t,o)=>{n.push({startStep:e.whenStep+6*o,pitch:48+t+a,durationSteps:Math.max(12,r-6*o),velocity:100})});else if("offbeat"===o){let o=Math.floor(A/4),l=Math.floor(o/2);for(let A=0;A<4;A++){let u=e.whenStep+A*o+l;if(u<e.whenStep+r)for(let e of t)n.push({startStep:u,pitch:48+e+a,durationSteps:Math.min(l,12),velocity:100})}}else if("yatsume"===o){let o=Math.floor(A/4),l=t=>Math.max(1,Math.round(t*o/480)),u=[0,360,960,1320],i=l(360);for(let o of u){let A=e.whenStep+l(o);if(A<e.whenStep+r)for(let e of t)n.push({startStep:A,pitch:48+e+a,durationSteps:i,velocity:100})}}else"alternating"===o&&t.forEach((t,o)=>{let r=o*Math.floor(A/4);n.push({startStep:e.whenStep+r,pitch:48+t+a,durationSteps:Math.max(12,Math.floor(A/4)),velocity:100})})}}else e.split(/[\s,]+/).filter(t=>t).forEach((t,e)=>{let o;try{o=[...V(t).notes]}catch{return}if(0===o.length)return;let r=e*A;o.forEach((t,e)=>{let o=3*e;n.push({startStep:r+o,pitch:48+t+a,durationSteps:A-o,velocity:100})})});return n})({chordStr:t.savedChordInput,patternType:t.savedChordPattern,rootShift:t.savedChordRoot,bpm:D,stepsPerBar:w.stepsPerBar});for(let t of(e.core.clearNotesWithoutHistory(),e.core.beginBatch(),o))e.core.addNote(t.startStep,t.pitch,{noteLengthSteps:Math.max(1,t.durationSteps),velocity:t.velocity});e.core.endBatch(),e.core.addHistoryOnce(),to()},tq=async t=>{if(!e.parseMidi)return;let o=await e.parseMidi(t),a=t6(o).filter(t=>t.selected).map(t=>t.index);tz(o,a)},tz=(t,e)=>{for(let t of(tk(),tY(),$))t.core.setLoadMode(!0);for(let t of $)t.lyrics="",t.lyricModel="",t.vocalVolume=200,t.vocalGate=100,t.vocalPan=64,t.vocalOctave=0;let{placements:o,bpm:a}=Q?((t,e,o)=>{let{tracks:a,division:r}=t,A=t4(t),n=r/48,l=[];return e.forEach((t,e)=>{if(e>=o.length)return;let r=a[t];if(!r)return;let A=o[e],u=[],i=0;for(let t of r)if(i+=t.delta,9!==t.channel){if(t.noteOn&&t.noteOn.velocity>0){let e=t.noteOn.noteNumber,o=t.noteOn.velocity;u.push({pitch:e,velocity:o,start:i,end:null})}else if(t.noteOff||t.noteOn&&0===t.noteOn.velocity){let e=t.noteOff||t.noteOn;if(e){let t=e.noteNumber;for(let e=u.length-1;e>=0;e--)if(u[e].pitch===t&&null===u[e].end){u[e].end=i;break}}}}for(let t of u){if(null===t.end)continue;let e=Math.round(t.start/n),o=Math.max(1,Math.round((t.end-t.start)/n));l.push({trackId:A,startStep:e,pitch:t.pitch,durationSteps:o,velocity:t.velocity})}}),{placements:l,bpm:A}})(t,e,$.map(t=>t.config.id)):((t,e)=>{let{tracks:o,division:a}=t,r=t4(t),A={};for(let t of e){let e=o[t];if(!e)continue;let a=0;for(let t of e)if(a+=t.delta,9!==t.channel){if(t.noteOn&&t.noteOn.velocity>0){let e=t.noteOn.noteNumber,o=t.noteOn.velocity,r=t.channel??0;A[r]||(A[r]=[]),A[r].push({pitch:e,velocity:o,start:a,end:null})}else if(t.noteOff||t.noteOn&&0===t.noteOn.velocity){let e=t.noteOff||t.noteOn;if(e){let o=e.noteNumber,r=t.channel??0;if(A[r])for(let t=A[r].length-1;t>=0;t--){let e=A[r][t];if(e.pitch===o&&null===e.end){e.end=a;break}}}}}}let n=4*a,l=8*n,u={};for(let[t,e]of Object.entries(A)){let o=Number.parseInt(t,10),a=e.filter(t=>null!==t.end);if(0===a.length){u[o]={avgPitch:60,maxSimultaneous:0,hasSubmelodyPattern:!1};continue}let r=a.reduce((t,e)=>t+e.pitch,0)/a.length,A=0,i=[...a].sort((t,e)=>t.start-e.start);for(let t=0;t<i.length;t++){let e=1;for(let o=t+1;o<i.length;o++)i[o].start<i[t].end&&e++;A=Math.max(A,e)}let s=()=>{if(0===i.length)return!1;let t=[],e=i[0].start,o=i[0].end;for(let a=1;a<i.length;a++)i[a].start-i[a-1].end>=n&&(t.push({start:e,end:o}),e=i[a].start),o=i[a].end;return t.push({start:e,end:o}),t.every(t=>t.end-t.start<l)};u[o]={avgPitch:r,maxSimultaneous:A,hasSubmelodyPattern:s()}}let i=Object.keys(A).map(Number).sort((t,e)=>t-e),s=[...i].sort((t,e)=>u[t].avgPitch-u[e].avgPitch),d=u[s[Math.floor(s.length/4)]]?.avgPitch??60,c=i.filter(t=>u[t].avgPitch<=d&&u[t].maxSimultaneous<=2),g=i.filter(t=>u[t].maxSimultaneous<=1&&!c.includes(t)),m=g.filter(t=>u[t].hasSubmelodyPattern),p=g.filter(t=>!u[t].hasSubmelodyPattern),C=i.filter(t=>!c.includes(t)&&!p.includes(t)&&!m.includes(t)),B={melody:p,submelody:m,bass:c,chord:C},h=[],E=a/48;for(let[t,e]of Object.entries(A)){let o=Number.parseInt(t,10),a=null;for(let[t,e]of Object.entries(B))if(e.includes(o)){a=t;break}if(a)for(let t of e){if(null===t.end)continue;let e=Math.round(t.start/E),o=Math.max(1,Math.round((t.end-t.start)/E));h.push({trackId:a,startStep:e,pitch:t.pitch,durationSteps:o,velocity:t.velocity})}}return{placements:h,bpm:r}})(t,e);for(let t of o){let e=$.find(e=>e.config.id===t.trackId);e&&e.core.addNote(t.startStep,t.pitch,{noteLengthSteps:t.durationSteps,velocity:t.velocity})}for(let t of(tW(Math.round(a)),$))t.core.setLoadMode(!1),t.core.addHistoryOnce();Y=0,P=0;let r=tP();null!==r?tK(r):ec(P,K),to(),tL(),tS()},tX=()=>(t=>{var e;let{tracks:o,drumPattern:a,drumVolume:r=80,bpm:A,stepsPerBar:n}=t,l=[];if(o.forEach((t,e)=>{if(0===t.notes.length)return;let o=e<9?e:e+1&15,a=[];for(let e of t.notes){let r=Math.round(10*e.startStep),A=Math.round((e.startStep+(e.durationSteps||1))*10),n=Math.round((e.velocity??100)*(t.volume??100)/100);a.push({t:r,m:[144|o,e.pitch,n]}),a.push({t:A,m:[144|o,e.pitch,0]})}a.sort((t,e)=>t.t-e.t),l.push(a)}),a&&a.length>0){let t=Math.max(...o.filter(t=>t.notes.length>0).map(t=>Math.max(...t.notes.map(t=>t.startStep+t.durationSteps))),n),e=[],A=Math.ceil(t/n);for(let o=0;o<A;o++){let A=o*n;for(let o of a){let a=A+o.step;if(a>=t)continue;let n=Math.round((o.velocity??1)*(r/100)*127);e.push({t:Math.round(10*a),m:[153,o.pitch,n]}),e.push({t:Math.round((a+1)*10),m:[153,o.pitch,0]})}}e.sort((t,e)=>t.t-e.t),e.length>0&&l.push(e)}let u=[];for(let t of(e=l.length+1,u.push(77,84,104,100),u.push(...t7(6)),u.push(...t8(1)),u.push(...t8(e)),u.push(...t8(480)),ee(u,t=>{t.push(0,255,81,3,...t9(Math.round(6e7/A)))}),l))ee(u,e=>{let o=0;for(let a of t)e.push(...et(a.t-o),...a.m),o=a.t});return new Blob([new Uint8Array(u).buffer],{type:"audio/midi"})})({tracks:$.map(t=>({notes:t.core.getNotes(),volume:t.volume})),drumPattern:I[L],drumVolume:S,bpm:D,stepsPerBar:w.stepsPerBar}),tW=t=>{for(let e of(D=t,b.bpmInput.value=String(t),$))e.core.setTempo(t)},tj=0,tZ=()=>{let t=Date.now();t-tj<100||(tj=t,_().core.undo(),to(),tS())},t$=()=>{_().core.redo(),to(),tS()},t_=t=>{b.overlay.hidden=!1,el(!0),setTimeout(()=>{t(),b.overlay.hidden=!0,el(!1)},30)},t0=null,t3=[],t1=t=>{if(t.ctrlKey||t.metaKey)if("KeyZ"!==t.code||t.shiftKey){if("KeyZ"===t.code&&t.shiftKey||"KeyY"===t.code)t.preventDefault(),t$();else if("KeyC"===t.code&&W.length>0)t.preventDefault(),Z=[...W];else if("KeyX"===t.code&&W.length>0){t.preventDefault(),Z=[...W];let e=_().core;for(let t of(e.beginBatch(),W))e.deleteNoteById(t.id);e.endBatch(),W=[]}else if("KeyV"===t.code&&Z.length>0){t.preventDefault();let e=_().core,o=e.getNotes(),a=Math.min(...Z.map(t=>t.startStep));for(let t of(e.beginBatch(),Z)){let r=Y+(t.startStep-a),A=r+t.durationSteps;o.some(e=>e.pitch===t.pitch&&r<e.startStep+e.durationSteps&&A>e.startStep)||e.addNote(r,t.pitch,{noteLengthSteps:t.durationSteps,velocity:t.velocity})}e.endBatch(),to()}}else t.preventDefault(),tZ()};tf(),$=E.map(t=>({config:t,core:new em({onMMLGenerated:()=>{},onNotesChanged:()=>{X&&(to(),tS())}},t.volume),volume:t.volume,savedChordInput:"",savedChordPattern:"block",savedChordRoot:0,lyrics:"",lyricModel:"",vocalVolume:200,vocalGate:100,vocalPan:64,vocalOctave:0})),X=!0,a=!1,r=!1,b.hScroll.addEventListener("pointerdown",t=>{a=!0,t.preventDefault(),b.hScroll.setPointerCapture(t.pointerId),A(t.clientX)}),b.vScroll.addEventListener("pointerdown",t=>{r=!0,t.preventDefault(),b.vScroll.setPointerCapture(t.pointerId),n(t.clientY)}),b.hScroll.addEventListener("pointermove",t=>{a&&A(t.clientX)}),b.vScroll.addEventListener("pointermove",t=>{r&&n(t.clientY)}),b.hScroll.addEventListener("pointerup",()=>{a=!1}),b.vScroll.addEventListener("pointerup",()=>{r=!1}),document.addEventListener("pointermove",t=>{a&&A(t.clientX),r&&n(t.clientY)}),document.addEventListener("pointerup",()=>{a=!1,r=!1}),A=t=>{let e=d,o=tt(),a=F*w.stepWidth,r=o*w.stepWidth-e.width+a;if(r<=0)return;let A=b.hScroll.getBoundingClientRect(),n=Number.parseFloat(b.hScrollThumb.style.width)||40,l=ez(t-A.left-n/2,0,A.width-n)/(A.width-n);ec(P=ez(l*r,0,r),K),to()},n=t=>{let e=te();if(e<=0)return;let o=b.vScroll.getBoundingClientRect(),a=Number.parseFloat(b.vScrollThumb.style.height)||40,r=ez(t-o.top-a/2,0,o.height-a)/(o.height-a);K=ez(r*e,0,e),ec(P,K),to()},b.playBtn.addEventListener("click",()=>{"playing"===G?tk():tx()}),b.playBtn.disabled=!1,b.prevBarBtn.addEventListener("click",()=>{eC(Math.max(0,Math.floor((eg()-1)/w.stepsPerBar)*w.stepsPerBar))}),b.nextBarBtn.addEventListener("click",()=>{eC(Math.floor(eg()/w.stepsPerBar+1)*w.stepsPerBar)}),b.soloCheckbox.addEventListener("change",()=>{H=b.soloCheckbox.checked}),b.toolPen.addEventListener("click",()=>tN("pen")),b.toolSelect.addEventListener("click",()=>tN("select")),b.toolEraser.addEventListener("click",()=>tN("eraser")),b.undoBtn.addEventListener("click",tZ),b.redoBtn.addEventListener("click",t$),b.noteLengthSelect.addEventListener("change",()=>{U=J=Number.parseInt(b.noteLengthSelect.value,10),to()}),b.bpmInput.addEventListener("input",()=>{tW(Number.parseInt(b.bpmInput.value,10)||120)}),b.zoomXIn.addEventListener("click",()=>{x=Math.min(200,x+25),tQ(),ty()}),b.zoomXOut.addEventListener("click",()=>{x=Math.max(25,x-25),tQ(),ty()}),b.zoomYIn.addEventListener("click",()=>{k=Math.min(200,k+25),tI(),ty()}),b.zoomYOut.addEventListener("click",()=>{k=Math.max(50,k-25),tI(),ty()}),b.decomposeChordToggle.addEventListener("change",ty),b.ignoreChordHeavyToggle.addEventListener("change",ty),b.masterVolume.addEventListener("input",()=>{M=Number.parseInt(b.masterVolume.value,10)||0,b.masterVolumeLabel.textContent=`${M}%`}),b.drumSelect.addEventListener("change",()=>{L=b.drumSelect.value,e.onDrumChange?.(L)}),b.drumVolume.addEventListener("input",()=>{S=Number.parseInt(b.drumVolume.value,10)||0,b.drumVolumeLabel.textContent=`${S}%`}),b.macroClear.addEventListener("click",()=>{let t=_();t.core.beginBatch(),t.core.clearNotesWithoutHistory(),t.core.endBatch(),t.core.saveHistory(),to()}),b.macroRandom.addEventListener("click",()=>{((t,e)=>{let{stepsPerBar:o,startStep:a,pitchRangeStart:r}=e,A=r+60,n=t5[Math.floor(Math.random()*t5.length)],l=Math.floor(12*Math.random()),u=[];for(let t=0;t<12;t++){let e=(t-l+12)%12;n.includes(e)&&u.push(A+t)}t.beginBatch();for(let e=0;e<8;e++){let r=a+e*o,A=Math.floor(4*Math.random())+2,n=new Set;for(let e=0;e<A;e++){let e=r+24*Math.floor(o/24*Math.random());if(n.has(e))continue;n.add(e);let a=u[Math.floor(Math.random()*u.length)];t.addNote(e,a,{noteLengthSteps:24})}}t.endBatch(),t.saveHistory()})(_().core,{stepsPerBar:w.stepsPerBar,startStep:Y,pitchRangeStart:w.pitchRangeStart}),to()}),b.macroHarmonic.addEventListener("click",()=>{let t=$.find(t=>"chord"===t.config.id);t&&"chord"!==N&&(((t,e,o)=>{let a=o.stepsPerBar/2,r=t.getNotes().concat(e.getNotes());if(0===r.length)return;let A=Math.ceil(Math.max(...r.map(t=>t.startStep+t.durationSteps))/a),n=new Set;t.beginBatch();for(let o=0;o<A;o++){let r=o*a,A=r+a,l=o%2==0,u=e.getNotes().filter(t=>t.startStep>=r&&t.startStep<A);if(u.length>0?n=new Set(u.map(t=>t.pitch%12)):l&&(n=new Set),0!==n.size)for(let e of t.getNotes().filter(t=>t.startStep>=r&&t.startStep<A))n.has(e.pitch%12)||t.deleteNoteById(e.id)}t.endBatch(),t.saveHistory()})(_().core,t.core,{stepsPerBar:w.stepsPerBar}),to())}),b.macroMono.addEventListener("click",()=>{let t=$.find(t=>"chord"===t.config.id);t&&"chord"!==N&&(((t,e,o)=>{let a=o.stepsPerBar/2,r=t.getNotes().concat(e.getNotes());if(0===r.length)return;let A=Math.ceil(Math.max(...r.map(t=>t.startStep+t.durationSteps))/a),n=new Set;t.beginBatch();for(let o=0;o<A;o++){let r=o*a,A=r+a,l=o%2==0,u=e.getNotes().filter(t=>t.startStep>=r&&t.startStep<A);if(u.length>0?n=new Set(u.map(t=>t.pitch%12)):l&&(n=new Set),0===n.size)continue;let i=t.getNotes().filter(t=>t.startStep>=r&&t.startStep<A),s=i.filter(t=>n.has(t.pitch%12)),d=new Set(s.map(t=>t.id));for(let e of i)d.has(e.id)||t.deleteNoteById(e.id);let c=new Map;for(let t of s)c.has(t.startStep)||c.set(t.startStep,[]),c.get(t.startStep)?.push(t);for(let e of c.values())if(e.length>1){e.sort((t,e)=>e.pitch-t.pitch);let[,...o]=e;for(let e of o)t.deleteNoteById(e.id)}}t.endBatch(),t.saveHistory()})(_().core,t.core,{stepsPerBar:w.stepsPerBar}),to())}),b.generateMmlBtn.addEventListener("click",()=>{let{full:t,minified:e,ignoredCount:o,trackCount:a,barLimit:r}=tJ();b.outputFull.textContent=t,b.outputMini.textContent=e;let A=b.decomposeChordToggle.checked,n=o>0?` / \u4F34\u594F${o}\u30C8\u30E9\u30C3\u30AF\u9664\u5916`:"",l=r>0?` / \u301C${r}\u5C0F\u7BC0`:"";b.outputStatus.textContent=`[${A?"和音分解":"通常"}] (${a}\u30C8\u30E9\u30C3\u30AF${n}${l}) \u901A\u5E38: ${t.length}\u6587\u5B57 / minify: ${e.length}\u6587\u5B57`,b.outputContainer.classList.remove("dtm-hidden"),tS()}),b.exportMidiBtn.addEventListener("click",()=>{let t=tX(),e=URL.createObjectURL(t),o=document.createElement("a");o.href=e,o.download="dtm.mid",o.click(),URL.revokeObjectURL(e)}),l=(t,e)=>{navigator.clipboard?.writeText(t),e.classList.add("dtm-btn--success"),setTimeout(()=>e.classList.remove("dtm-btn--success"),1200)},b.copyFullBtn.addEventListener("click",()=>l(b.outputFull.textContent??"",b.copyFullBtn)),b.copyMiniBtn.addEventListener("click",()=>l(b.outputMini.textContent??"",b.copyMiniBtn)),b.mmlLoadBtn.addEventListener("click",()=>t_(()=>tH(b.mmlInput.value))),u=null,C=null,B=()=>{if(u&&(u.stop(),u.destroy(),u=null),C){C.textContent="▶ 試聴",C.classList.remove("dtm-btn--danger"),C.classList.add("dtm-btn--primary");let t=C.closest(".dtm-modal-sample-box"),e=t?.querySelector(".dtm-modal-sample-player-container");e&&(e.innerHTML=""),C=null}},o=(t,o)=>{for(let e of(B(),b.modalTitle.textContent=t,b.modalBody.innerHTML=o,b.modalOverlay.removeAttribute("hidden"),b.modalBody.querySelectorAll(".dtm-modal-sample-copy-btn")))e.addEventListener("click",()=>{let t=e.getAttribute("data-mml")||"";navigator.clipboard.writeText(t).then(()=>{let t=e.textContent;e.textContent="✓ コピー完了",e.classList.add("dtm-btn--success"),setTimeout(()=>{e.textContent=t,e.classList.remove("dtm-btn--success")},1200)})});for(let t of b.modalBody.querySelectorAll(".dtm-modal-sample-play-btn")){let o=t;o.addEventListener("click",()=>{let t=o.closest(".dtm-modal-sample-box"),a=t?.querySelector(".dtm-modal-sample-player-container"),r=o.getAttribute("data-mml")||"";if(C===o)u&&u.isPlaying()?u.stop():(tk(),u&&(u.play(),o.textContent="■ 停止",o.classList.remove("dtm-btn--primary"),o.classList.add("dtm-btn--danger")));else if(B(),tk(),C=o,o.textContent="■ 停止",o.classList.remove("dtm-btn--primary"),o.classList.add("dtm-btn--danger"),a){a.innerHTML="";let t=eP(a,r,{onPlayNote:t=>{if(e.onPlayNote){let o=E[Number(t.trackId)],a=o?o.id:t.trackId;e.onPlayNote({...t,trackId:a})}},onPlayDrum:e.onPlayDrum,onResumeAudio:e.onResumeAudio,getAudioTime:e.getAudioTime,singingVoices:e.singingVoices,drumPatterns:e.drumPatterns,volume:M,onStop:()=>{C===o&&(o.textContent="▶ 試聴",o.classList.remove("dtm-btn--danger"),o.classList.add("dtm-btn--primary"))}});u=t,t.play()}})}},b.modalClose.addEventListener("click",()=>{B(),b.modalOverlay.setAttribute("hidden","")}),b.modalOverlay.addEventListener("click",t=>{t.target===b.modalOverlay&&(B(),b.modalOverlay.setAttribute("hidden",""))}),b.mmlInfoBtn.addEventListener("click",()=>{o("MMLの書き方解説",ep)}),b.midiInfoBtn.addEventListener("click",()=>{o("MIDIの読み込み解説",eY)}),b.shiftApplyBtn.addEventListener("click",()=>t_(()=>{((t,e)=>{if(0!==e)for(let o of t)for(let t of[...o.getNotes()]){let a=t.startStep+e;a<0?o.deleteNoteById(t.id):o.moveNote(t.id,a,t.pitch)}})($.map(t=>t.core),Number.parseInt(b.shiftSelect.value,10)||0),to()})),v&&(b.midiInput.addEventListener("change",async()=>{let t=b.midiInput.files?.[0];if(!t||!e.parseMidi)return;b.overlay.hidden=!1,el(!0);let o=new Uint8Array(await t.arrayBuffer());t3=t6(t0=await e.parseMidi(o)),b.midiTrackSelection.innerHTML='<span class="dtm-label">トラック</span>',t3.forEach((t,e)=>{let o=document.createElement("button");o.className=`dtm-btn ${t.selected?"dtm-btn--primary":"dtm-btn--ghost"}`,o.dataset.selected=String(t.selected),o.textContent=`${t.name} (${t.noteCount})`,o.addEventListener("click",()=>{let t="true"!==o.dataset.selected;o.dataset.selected=String(t),o.classList.toggle("dtm-btn--primary",t),o.classList.toggle("dtm-btn--ghost",!t)}),b.midiTrackSelection.appendChild(o),0===e&&(b.midiTrackSelection.dataset.ready="1")}),b.midiTrackSelection.classList.remove("dtm-hidden"),b.overlay.hidden=!0,el(!1)}),b.midiLoadBtn.addEventListener("click",()=>{if(!t0)return;let t=[];b.midiTrackSelection.querySelectorAll("button").forEach((e,o)=>{"true"===e.dataset.selected&&t.push(t3[o].index)}),0!==t.length&&t_(()=>tz(t0,t))})),document.addEventListener("keydown",t1),b.root.addEventListener("keydown",t=>{let e=t.target;"TEXTAREA"!==e.tagName&&"INPUT"!==e.tagName||(t.ctrlKey||t.metaKey)&&["KeyZ","KeyY","KeyV","KeyC","KeyX"].includes(t.code)&&t.stopPropagation()}),tW(D),tL(),tM(),tS(),to(),e.initialMML&&tH(e.initialMML);let t2=null,eo=new ResizeObserver(()=>{t2&&clearTimeout(t2),t2=setTimeout(()=>tf(),150)});eo.observe(b.rollContainer),document.addEventListener("pointermove",th),document.addEventListener("pointerup",tE);let el=t=>{b.topbar.classList.toggle("is-loading",t)},eg=()=>"playing"===G?z:"paused"===G?q:Y,eC=async t=>{"playing"===G?(tF.stop(),e.singingVoices?.stopStream(),Y=t,q=t,z=t,G="paused",await tx()):eB(t)},eB=t=>{Y=t,q=t,z=t,G="paused";let e=d;ec(P=Math.max(0,t*w.stepWidth-.5*e.width),K),tM(),to()};return{play:tx,pause:()=>{"playing"===G&&(q=z,tF.stop(),e.singingVoices?.stopStream(),G="paused",tM())},stop:tk,getMML:tJ,setInstrument:t=>{R=t},getDrum:()=>L,setDrum:t=>{("none"===t||I[t])&&(L=t,b.drumSelect.value=t,e.onDrumChange?.(t))},getViewState:tv,setViewState:t=>{"number"==typeof t.zoomX&&(x=ez(t.zoomX,25,200),tQ()),"number"==typeof t.zoomY&&(k=ez(t.zoomY,50,200),tI()),"boolean"==typeof t.decomposeChord&&(b.decomposeChordToggle.checked=t.decomposeChord),"boolean"==typeof t.ignoreChordHeavy&&(b.ignoreChordHeavyToggle.checked=t.ignoreChordHeavy)},loadMML:tH,loadMIDI:tq,exportMIDI:tX,setBpm:tW,getPlaybackState:()=>G,getCurrentPlayStep:eg,forcePauseAt:eB,setLoading:el,destroy:()=>{tF.stop(),e.singingVoices?.stopStream(),eo.disconnect(),document.removeEventListener("pointermove",th),document.removeEventListener("pointerup",tE),document.removeEventListener("keydown",t1),t.innerHTML=""}}})(t,{getAudioTime:()=>A.currentTime,onResumeAudio:C,onPlayNote:t=>{let e=M(v,t.trackId,y?"advanced":"simple");e&&e.play({ctx:A,destination:n,pitch:t.pitch,volume:t.volume,when:t.when,duration:t.duration})},onPlayDrum:N,singingVoices:Q,parseMidi:o,onInstrumentChange:t=>{v=t,b&&b.setValue(t),u?.(t)},...B});if(U.push(w),l??r.presetUI){T.get(t)?.destroy();let e=t.querySelector('[data-dtm="roll"]');b=R(t,{getDaw:()=>w,getTrackIds:()=>h,value:I,loadingTarget:e??t,position:"prepend",onChange:t=>{v=t}}),T.set(t,b)}return w.setInstrument(I),w.setLoading?.(!0),S(I,h,y?"advanced":"simple").finally(()=>{w.setLoading?.(!1)}),{...w,setInstrument:t=>{w.setInstrument(t),v=t,b&&b.setValue(t)},destroy:()=>{w.destroy(),b?.destroy(),T.get(t)===b&&T.delete(t);let e=U.indexOf(w);e>=0&&U.splice(e,1)}}};return{audioContext:A,singingVoices:Q,mountEditor:K,mountPlayer:(t,e,o={})=>{let a=eQ(e,{}),r=a.meta??{},l=r.instrument&&tB[r.instrument]?r.instrument:F,u="advanced"===r.mode,i=[...new Set(a.placements.map(t=>t.trackIndex))].map(t=>x(t,u?"advanced":"simple"));S(l,i.length>0?i:[...e2],u?"advanced":"simple");let s=eP(t,e,{getAudioTime:()=>A.currentTime,onResumeAudio:C,onPlayNote:t=>{let e=M(l,x(Number(t.trackId),u?"advanced":"simple"),u?"advanced":"simple");e&&e.play({ctx:A,destination:n,pitch:t.pitch,volume:t.volume,when:t.when,duration:t.duration})},onPlayDrum:N,singingVoices:Q,...o});return J.push(s),{...s,destroy:()=>{s.destroy();let t=J.indexOf(s);t>=0&&J.splice(t,1)}}},loadPreset:S,defaultPreset:F,mountPresetSelect:R,mountModeSwitch:(t,e)=>{let o=t.ownerDocument,a=e.tracksFor??(t=>"advanced"===t?eO:eH),r={simple:e.labels?.simple??"シンプル",advanced:e.labels?.advanced??"アドバンス"},A=t=>"function"==typeof e.editorOptions?e.editorOptions(t):e.editorOptions??{},n=e.mode??"simple",l=null,u=o.createElement("div");if(u.className=e.className??"dtm-controlbar",null!==e.label){let t=o.createElement("span");t.className="dtm-controlbar-label",t.textContent=e.label??"MODE",u.appendChild(t)}let i=o.createElement("div");i.className="dtm-modeseg";let s=new Map,d=()=>{for(let[t,e]of s)e.classList.toggle("dtm-modebtn--active",t===n)};for(let t of["simple","advanced"]){let e=o.createElement("button");e.type="button",e.className="dtm-modebtn",e.textContent=r[t],e.addEventListener("click",()=>m(t)),i.appendChild(e),s.set(t,e)}u.appendChild(i);let c=(o,r)=>{let n=A(o);l=K(e.editorTarget,{...n,mode:o,tracks:a(o),initialMML:r??n.initialMML}),"prepend"===e.position?t.insertBefore(u,t.firstChild):t.appendChild(u),e.onMount?.(l,o)},g=()=>{if(!l)return;let t=l.getMML().full;return e.onUnmount?.(l,n),l.destroy(),l=null,t};function m(t){if(t===n&&l)return;let o=g();n=t,d(),e.onChange?.(t),c(t,o)}d(),c(n,A(n).initialMML);let p={element:u,getDaw:()=>l,getMode:()=>n,setMode:m,destroy:()=>{g(),u.remove();let t=P.indexOf(p);t>=0&&P.splice(t,1)}};return P.push(p),p},dispose:()=>{for(let t of[...P])t.destroy();for(let t of J)t.destroy();for(let t of U)t.destroy();P.length=0,J.length=0,U.length=0,A.close()}}};let e4=Function("url","return import(url)");async function e8(t,e){let o=await e4(t);return o[e]??o.default}let e9=null;t.s(["getStudio",0,()=>(e9||(e9=(async()=>{let[t,e,o]=await Promise.all([e8("https://rpgen3.github.io/soundfont/mjs/surikov/SoundFont.mjs","SoundFont"),e8("https://rpgen3.github.io/soundfont/mjs/surikov/SoundFont_drum.mjs","SoundFont_drum"),e8("https://rpgen3.github.io/soundfont/mjs/surikov/SoundFont_list.mjs","SoundFont_list")]);return e6({engines:{SoundFont:t,SoundFont_drum:e,SoundFont_list:o}})})()),e9)],48605)}]);