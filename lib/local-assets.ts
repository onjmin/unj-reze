...
export const LOCAL_TILE_SHEETS: LocalTileSheet[] = [
	...
	},
	{
		id: "reze-field",
		name: "レゼ フィールド",
		url: "/assets/rpg-reze/field.png",
		tile: 16,
		cols: 30,
		rows: 16,
		scanBlockWidth: 6,
		hideIdenticalBlockRows: true,
		showAllAtOnce: true,
	},
	{
		id: "reze-base",
		name: "レゼ ベースチップ",
		url: "/assets/rpg-reze/Base.png",
		tile: 16,
		cols: 8,
		rows: 652,
		sections: REZE_BASE_SECTIONS,
	},
];

/** タイル1マスのクロップ付き URL（imageUrl / `url:` 参照の中身）。 */
export function localTileUrl(
